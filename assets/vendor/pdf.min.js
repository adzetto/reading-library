var pdfjsLib = (() => {
  ...
  __export(pdf_min_exports, {
    AbortException: () => Gt,
    AnnotationEditorLayer: () => Vt,
    AnnotationEditorParamsType: () => $t,
    AnnotationEditorType: () => Wt,
    ...
    MissingPDFException: () => se,
    OPS: () => ne,
    OutputScale: () => re,
    PDFDataRangeTransport: () => ae,
    PDFDateString: () => oe,
    PDFWorker: () => le,
    PasswordResponses: () => he,
    PermissionFlag: () => ce,
    PixelsPerInch: () => de,
    RenderingCancelledException: () => ue,
    TextLayer: () => pe,
    TouchManager: () => ge,
    ...
    XfaLayer: () => ve,
    build: () => ye,
    createValidAbsoluteUrl: () => we,
    fetchData: () => Ae,
    getDocument: () => xe,
    getFilenameFromUrl: () => _e,
    getPdfFilenameFromUrl: () => Ee,
    getXfaPageViewport: () => Se,
    isDataScheme: () => Ce,
    isPdfFile: () => Te,
    noContextMenu: () => Me,
    normalizeUnicode: () => Pe,
    setLayerDimensions: () => De,
    shadow: () => ke,
    stopEvent: () => Re,
    version: () => Ie
  });
  ...
  var t = { 9306: (t2, e2, i2) => {
    ...
    var s2 = i2(4576), n2 = i2(9504), r2 = i2(6706), a2 = i2(7696), o2 = i2(5169), l2 = i2(7394), h2 = i2(4483), c2 = i2(1548), d2 = s2.structuredClone, u2 = s2.ArrayBuffer, p2 = s2.DataView, g2 = Math.min, f2 = u2.prototype, m2 = p2.prototype, b2 = n2(f2.slice), v2 = r2(f2, "resizable", "get"), y2 = r2(f2, "maxByteLength", "get"), w2 = n2(m2.getInt8), A2 = n2(m2.setInt8);
    t2.exports = (c2 || h2) && function(t3, e3, i3) {
      ...
      if (n3 >= r3 && (!i3 || f3)) s3 = b2(t3, 0, r3);
        ...
        var m3 = i3 && !f3 && y2 ? { maxByteLength: y2(t3) } : void 0;
        s3 = new u2(r3, m3);
        for (var x2 = new p2(t3), _2 = new p2(s3), E2 = g2(r3, n3), S2 = 0; S2 < E2; S2++) A2(_2, S2, w2(x2, S2));
      }
      c2 || h2(t3);
      return s3;
    };
  }, 4644: (t2, e2, i2) => {
    var s2, n2, r2, a2 = i2(7811), o2 = i2(3724), l2 = i2(4576), h2 = i2(4901), c2 = i2(34), d2 = i2(9297), u2 = i2(6955), p2 = i2(6823), g2 = i2(6699), f2 = i2(6840), m2 = i2(2106), b2 = i2(1625), v2 = i2(2787), y2 = i2(2967), w2 = i2(8227), A2 = i2(3392), x2 = i2(1181), _2 = x2.enforce, E2 = x2.get, S2 = l2.Int8Array, C2 = S2 && S2.prototype, T2 = l2.Uint8ClampedArray, M2 = T2 && T2.prototype, P2 = S2 && v2(S2), D2 = C2 && v2(C2), k2 = Object.prototype, R2 = l2.TypeError, I2 = w2("toStringTag"), L2 = A2("TYPED_ARRAY_TAG"), O2 = "TypedArrayConstructor", N2 = a2 && !!y2 && "Opera" !== u2(l2.opera), B2 = false, H2 = { Int8Array: 1, Uint8Array: 1, Uint8ClampedArray: 1, Int16Array: 2, Uint16Array: 2, Int32Array: 4, Uint32Array: 4, Float32Array: 4, Float64Array: 8 }, U2 = { BigInt64Array: 8, BigUint64Array: 8 }, getTypedArrayConstructor = function(t3) {
      var e3 = v2(t3);
      if (c2(e3)) {
        var i3 = E2(e3);
    ...
    if (!N2 || !h2(P2) || P2 === Function.prototype) {
      P2 = function TypedArray() {
        throw new R2("Incorrect invocation");
      };
      if (N2) for (s2 in H2) l2[s2] && y2(l2[s2], P2);
    }
    if (!N2 || !D2 || D2 === k2) {
      D2 = P2.prototype;
      if (N2) for (s2 in H2) l2[s2] && y2(l2[s2].prototype, D2);
    }
    N2 && v2(M2) !== D2 && y2(M2, D2);
    if (o2 && !d2(D2, I2)) {
      B2 = true;
      m2(D2, I2, { configurable: true, get: function() {
        return c2(this) ? this[L2] : void 0;
      } });
      for (s2 in H2) l2[s2] && g2(l2[s2], L2, s2);
    }
    t2.exports = { NATIVE_ARRAY_BUFFER_VIEWS: N2, TYPED_ARRAY_TAG: B2 && L2, aTypedArray: function(t3) {
      if (isTypedArray(t3)) return t3;
      throw new R2("Target is not a typed array");
    }, aTypedArrayConstructor: function(t3) {
      if (h2(t3) && (!y2 || b2(P2, t3))) return t3;
      throw new R2(p2(t3) + " is not a typed array constructor");
      ...
      if (o2) {
        ...
        D2[t3] && !i3 || f2(D2, t3, i3 ? e3 : N2 && C2[t3] || e3, s3);
      }
      ...
      if (o2) {
        if (y2) {
          ...
          if (P2[t3] && !i3) return;
          try {
            return f2(P2, t3, i3 ? e3 : N2 && P2[t3] || e3);
          } catch (t4) {
          }
        }
    ...
    }, isTypedArray, TypedArray: P2, TypedArrayPrototype: D2 };
  }, 5370: (t2, e2, i2) => {
    var s2 = i2(6198);
    ...
    t2.exports = function(t3, e3, i3) {
      i3.get && s2(i3.get, e3, { getter: true });
      i3.set && s2(i3.set, e3, { setter: true });
    ...
    t2.exports = function(t3, e3, i3) {
      var f2, m2, b2, v2, y2, w2, A2, x2 = i3 && i3.that, _2 = !(!i3 || !i3.AS_ENTRIES), E2 = !(!i3 || !i3.IS_RECORD), S2 = !(!i3 || !i3.IS_ITERATOR), C2 = !(!i3 || !i3.INTERRUPTED), T2 = s2(e3, x2), stop = function(t4) {
        f2 && u2(f2, "normal", t4);
        return new Result(true, t4);
      }, callFn = function(t4) {
        if (_2) {
          r2(t4);
          return C2 ? T2(t4[0], t4[1], stop) : T2(t4[0], t4[1]);
        }
        return C2 ? T2(t4, stop) : T2(t4);
      };
      ...
      w2 = E2 ? t3.next : f2.next;
      for (; !(A2 = n2(w2, f2)).done; ) {
        try {
          y2 = callFn(A2.value);
        } catch (t4) {
          u2(f2, "throw", t4);
    ...
    var s2 = i2(9565), n2 = i2(2360), r2 = i2(6699), a2 = i2(6279), o2 = i2(8227), l2 = i2(1181), h2 = i2(5966), c2 = i2(7657).IteratorPrototype, d2 = i2(2529), u2 = i2(9539), p2 = o2("toStringTag"), g2 = "IteratorHelper", f2 = "WrapForValidIterator", m2 = l2.set, createIteratorProxyPrototype = function(t3) {
      ...
      return a2(n2(c2), { next: function next() {
        var i3 = e3(this);
    ...
    var s2 = i2(9565), n2 = i2(9306), r2 = i2(8551), a2 = i2(1767), o2 = i2(9462), l2 = i2(6319), h2 = o2((function() {
      ...
      if (!(this.done = !!e3.done)) return l2(t3, this.mapper, [e3.value, this.counter++], true);
    }));
    t2.exports = function map(t3) {
      r2(this);
      n2(t3);
      return new h2(a2(this), { mapper: t3 });
    };
  }, 7657: (t2, e2, i2) => {
    ...
    t2.exports = { IteratorPrototype: s2, BUGGY_SAFARI_ITERATORS: f2 };
  }, 6269: (t2) => {
    t2.exports = {};
  }, 6198: (t2, e2, i2) => {
    var s2 = i2(8014);
    ...
    var s2 = i2(9504), n2 = i2(9039), r2 = i2(4901), a2 = i2(9297), o2 = i2(3724), l2 = i2(350).CONFIGURABLE, h2 = i2(3706), c2 = i2(1181), d2 = c2.enforce, u2 = c2.get, p2 = String, g2 = Object.defineProperty, f2 = s2("".slice), m2 = s2("".replace), b2 = s2([].join), v2 = o2 && !n2((function() {
      ...
      v2 && i3 && a2(i3, "arity") && t3.length !== i3.arity && g2(t3, "length", { value: i3.arity });
      try {
    ...
    e2.f = s2 ? r2 ? function defineProperty(t3, e3, i3) {
      ...
      if ("function" == typeof t3 && "prototype" === e3 && "value" in i3 && p2 in i3 && !i3[p2]) {
        ...
        if (s3 && s3[p2]) {
          t3[e3] = i3.value;
          i3 = { configurable: u2 in i3 ? i3[u2] : s3[u2], enumerable: d2 in i3 ? i3[d2] : s3[d2], writable: false };
        }
      }
      return h2(t3, e3, i3);
    ...
    (o2.versions || (o2.versions = [])).push({ version: "3.39.0", mode: s2 ? "pure" : "global", copyright: "\xA9 2014-2024 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.39.0/LICENSE", source: "https://github.com/zloirock/core-js" });
  }, 5745: (t2, e2, i2) => {
    var s2 = i2(7629);
    t2.exports = function(t3, e3) {
    ...
    s2 && !("detached" in a2) && n2(a2, "detached", { configurable: true, get: function detached() {
      return r2(this);
    } });
  }, 7936: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(5636);
    n2 && s2({ target: "ArrayBuffer", proto: true }, { transferToFixedLength: function transferToFixedLength() {
      return n2(this, arguments.length ? arguments[0] : void 0, false);
    } });
  }, 8100: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(5636);
    n2 && s2({ target: "ArrayBuffer", proto: true }, { transfer: function transfer() {
    ...
    var s2 = i2(6518), n2 = i2(4576), r2 = i2(679), a2 = i2(8551), o2 = i2(4901), l2 = i2(2787), h2 = i2(2106), c2 = i2(4659), d2 = i2(9039), u2 = i2(9297), p2 = i2(8227), g2 = i2(7657).IteratorPrototype, f2 = i2(3724), m2 = i2(6395), b2 = "constructor", v2 = "Iterator", y2 = p2("toStringTag"), w2 = TypeError, A2 = n2[v2], x2 = m2 || !o2(A2) || A2.prototype !== g2 || !d2((function() {
      A2({});
      ...
      f2 ? h2(g2, t3, { configurable: true, get: function() {
        return e3;
      }, set: function(e4) {
        a2(this);
    ...
    _2.prototype = g2;
    s2({ global: true, constructor: true, forced: x2 }, { Iterator: _2 });
  }, 9314: (t2, e2, i2) => {
    ...
    s2({ target: "Iterator", proto: true, real: true, forced: c2 }, { drop: function drop(t3) {
      r2(this);
      var e3 = l2(o2(+t3));
      return new d2(a2(this), { remaining: e3 });
    } });
  }, 1148: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(2652), r2 = i2(9306), a2 = i2(8551), o2 = i2(1767);
    s2({ target: "Iterator", proto: true, real: true }, { every: function every(t3) {
      a2(this);
      r2(t3);
      var e3 = o2(this), i3 = 0;
    ...
    var s2 = i2(6518), n2 = i2(9565), r2 = i2(9306), a2 = i2(8551), o2 = i2(1767), l2 = i2(9462), h2 = i2(6319), c2 = i2(6395), d2 = l2((function() {
      for (var t3, e3, i3 = this.iterator, s3 = this.predicate, r3 = this.next; ; ) {
        ...
        if (this.done = !!t3.done) return;
        e3 = t3.value;
        if (h2(i3, s3, [e3, this.counter++], true)) return e3;
      }
    }));
    s2({ target: "Iterator", proto: true, real: true, forced: c2 }, { filter: function filter(t3) {
      a2(this);
      r2(t3);
      return new d2(o2(this), { predicate: t3 });
    } });
  }, 531: (t2, e2, i2) => {
    ...
    s2({ target: "Iterator", proto: true, real: true, forced: d2 }, { flatMap: function flatMap(t3) {
      a2(this);
      r2(t3);
      return new u2(o2(this), { mapper: t3, inner: null });
    } });
  }, 1701: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(713);
    s2({ target: "Iterator", proto: true, real: true, forced: i2(6395) }, { map: n2 });
  }, 3579: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(2652), r2 = i2(9306), a2 = i2(8551), o2 = i2(1767);
    s2({ target: "Iterator", proto: true, real: true }, { some: function some(t3) {
      a2(this);
      r2(t3);
      var e3 = o2(this), i3 = 0;
      return n2(e3, (function(e4, s3) {
    ...
    s2({ target: "Promise", stat: true, forced: !c2 || !c2.try || h2((function() {
      ...
      (s3.error ? i3.reject : i3.resolve)(s3.value);
      return i3.promise;
    } });
  }, 4628: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(6043);
    s2({ target: "Promise", stat: true }, { withResolvers: function withResolvers() {
      var t3 = n2.f(this);
      return { promise: t3.promise, resolve: t3.resolve, reject: t3.reject };
    } });
  }, 7642: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(3440);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("difference") }, { difference: n2 });
  }, 8004: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(9039), r2 = i2(8750);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("intersection") || n2((function() {
      return "3,2" !== String(Array.from((/* @__PURE__ */ new Set([1, 2, 3])).intersection(/* @__PURE__ */ new Set([3, 2]))));
    })) }, { intersection: r2 });
  }, 3853: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(4449);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("isDisjointFrom") }, { isDisjointFrom: n2 });
  }, 5876: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(3838);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("isSubsetOf") }, { isSubsetOf: n2 });
  }, 2475: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(8527);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("isSupersetOf") }, { isSupersetOf: n2 });
  }, 5024: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(3650);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("symmetricDifference") }, { symmetricDifference: n2 });
  }, 1698: (t2, e2, i2) => {
    var s2 = i2(6518), n2 = i2(4204);
    s2({ target: "Set", proto: true, real: true, forced: !i2(4916)("union") }, { union: n2 });
  }, 7467: (t2, e2, i2) => {
    ...
    var s2 = i2(6518), n2 = i2(3724), r2 = i2(4576), a2 = i2(7751), o2 = i2(9504), l2 = i2(9565), h2 = i2(4901), c2 = i2(34), d2 = i2(4376), u2 = i2(9297), p2 = i2(655), g2 = i2(6198), f2 = i2(4659), m2 = i2(9039), b2 = i2(8235), v2 = i2(4495), y2 = r2.JSON, w2 = r2.Number, A2 = r2.SyntaxError, x2 = y2 && y2.parse, _2 = a2("Object", "keys"), E2 = Object.getOwnPropertyDescriptor, S2 = o2("".charAt), C2 = o2("".slice), T2 = o2(/./.exec), M2 = o2([].push), P2 = /^\d$/, D2 = /^[1-9]$/, k2 = /^[\d-]$/, R2 = /^[\t\n\r ]$/, internalize = function(t3, e3, i3, s3) {
      var n3, r3, a3, o3, h3, p3 = t3[e3], f3 = s3 && p3 === s3.value, m3 = f3 && "string" == typeof s3.source ? { source: s3.source } : {};
      if (c2(p3)) {
    ...
    Context.prototype = { fork: function(t3) {
      ...
      var t3 = this.source, e3 = this.skip(R2, this.index), i3 = this.fork(e3), s3 = S2(t3, e3);
      ...
      throw new A2('Unexpected character: "' + s3 + '" at: ' + e3);
    }, node: function(t3, e3, i3, s3, n3) {
      return new Node2(e3, s3, t3 ? null : C2(this.source, i3, s3), n3);
    }, object: function() {
      ...
      if ("0" === S2(t3, i3)) i3++;
        ...
        if (!T2(D2, S2(t3, i3))) throw new A2("Failed to parse number at: " + i3);
        i3 = this.skip(P2, i3 + 1);
      }
      "." === S2(t3, i3) && (i3 = this.skip(P2, i3 + 1));
      if ("e" === S2(t3, i3) || "E" === S2(t3, i3)) {
        i3++;
        "+" !== S2(t3, i3) && "-" !== S2(t3, i3) || i3++;
      ...
      if (C2(this.source, i3, s3) !== e3) throw new A2("Failed to parse value at: " + i3);
      return this.node(0, t3, i3, s3);
    }, skip: function(t3, e3) {
      for (var i3 = this.source; e3 < i3.length && T2(t3, S2(i3, e3)); e3++) ;
      return e3;
    }, until: function(t3, e3) {
      e3 = this.skip(R2, e3);
      for (var i3 = S2(this.source, e3), s3 = 0; s3 < t3.length; s3++) if (t3[s3] === i3) return e3;
    ...
    s2({ target: "JSON", stat: true, forced: I2 }, { parse: function parse(t3, e3) {
      return L2 && !h2(e3) ? x2(t3) : (function(t4, e4) {
        t4 = p2(t4);
        var i3 = new Context(t4, 0, ""), s3 = i3.parse(), n3 = s3.value, r3 = i3.skip(R2, s3.end);
        if (r3 < t4.length) throw new A2('Unexpected extra character: "' + S2(t4, r3) + '" after the parsed data at: ' + r3);
        return h2(e4) ? internalize({ "": n3 }, "", e4, s3) : n3;
      })(t3, e3);
    } });
  }, 5247: (t2, e2, i2) => {
    i2(1689);
    ...
    var s2 = i2(6518), n2 = i2(4576), r2 = i2(7751), a2 = i2(6980), o2 = i2(4913).f, l2 = i2(9297), h2 = i2(679), c2 = i2(3167), d2 = i2(2603), u2 = i2(5002), p2 = i2(8574), g2 = i2(3724), f2 = i2(6395), m2 = "DOMException", b2 = r2("Error"), v2 = r2(m2), y2 = function DOMException() {
      ...
      c2(s3, this, y2);
      return s3;
    }, w2 = y2.prototype = v2.prototype, A2 = "stack" in new b2(m2), x2 = "stack" in new v2(1, 2), _2 = v2 && g2 && Object.getOwnPropertyDescriptor(n2, m2), E2 = !(!_2 || _2.writable && _2.configurable), S2 = A2 && !E2 && !x2;
    s2({ global: true, constructor: true, forced: f2 || S2 }, { DOMException: S2 ? y2 : v2 });
    var C2 = r2(m2), T2 = C2.prototype;
    if (T2.constructor !== C2) {
      f2 || o2(T2, "constructor", a2(1, C2));
      for (var M2 in u2) if (l2(u2, M2)) {
        var P2 = u2[M2], D2 = P2.s;
        l2(C2, D2) || o2(C2, D2, a2(6, P2.c));
      }
    }
  }, 4603: (t2, e2, i2) => {
    ...
    s2 && !("size" in a2) && r2(a2, "size", { get: function size() {
      var t3 = 0;
      o2(this, (function() {
        t3++;
      }));
  ...
  var f = { DISABLE: -1, NONE: 0, FREETEXT: 3, HIGHLIGHT: 9, STAMP: 13, INK: 15 };
  ...
  var x = 3;
  var _ = 4;
  var E = { GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3 };
  var S = 1;
  var C = 2;
  var T = 3;
  var M = 4;
  ...
  var q = 4;
  var X = 5;
  var Y = { ERRORS: 0, WARNINGS: 1, INFOS: 5 };
  var K = { dependency: 1, setLineWidth: 2, setLineCap: 3, setLineJoin: 4, setMiterLimit: 5, setDash: 6, setRenderingIntent: 7, setFlatness: 8, setGState: 9, save: 10, restore: 11, transform: 12, moveTo: 13, lineTo: 14, curveTo: 15, curveTo2: 16, curveTo3: 17, closePath: 18, rectangle: 19, stroke: 20, closeStroke: 21, fill: 22, eoFill: 23, fillStroke: 24, eoFillStroke: 25, closeFillStroke: 26, closeEOFillStroke: 27, endPath: 28, clip: 29, eoClip: 30, beginText: 31, endText: 32, setCharSpacing: 33, setWordSpacing: 34, setHScale: 35, setLeading: 36, setFont: 37, setTextRenderingMode: 38, setTextRise: 39, moveText: 40, setLeadingMoveText: 41, setTextMatrix: 42, nextLine: 43, showText: 44, showSpacedText: 45, nextLineShowText: 46, nextLineSetSpacingShowText: 47, setCharWidth: 48, setCharWidthAndBounds: 49, setStrokeColorSpace: 50, setFillColorSpace: 51, setStrokeColor: 52, setStrokeColorN: 53, setFillColor: 54, setFillColorN: 55, setStrokeGray: 56, setFillGray: 57, setStrokeRGBColor: 58, setFillRGBColor: 59, setStrokeCMYKColor: 60, setFillCMYKColor: 61, shadingFill: 62, beginInlineImage: 63, beginImageData: 64, endInlineImage: 65, paintXObject: 66, markPoint: 67, markPointProps: 68, beginMarkedContent: 69, beginMarkedContentProps: 70, endMarkedContent: 71, beginCompat: 72, endCompat: 73, paintFormXObjectBegin: 74, paintFormXObjectEnd: 75, beginGroup: 76, endGroup: 77, beginAnnotation: 80, endAnnotation: 81, paintImageMaskXObject: 83, paintImageMaskXObjectGroup: 84, paintImageXObject: 85, paintInlineImageXObject: 86, paintInlineImageXObjectGroup: 87, paintImageXObjectRepeat: 88, paintImageMaskXObjectRepeat: 89, paintSolidColorImageMask: 90, constructPath: 91, setStrokeTransparent: 92, setFillTransparent: 93 };
  var Q = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
  var J = Y.WARNINGS;
  ...
  function info(t2) {
    J >= Y.INFOS && console.log(`Info: ${t2}`);
  }
  function warn(t2) {
    J >= Y.WARNINGS && console.log(`Warning: ${t2}`);
  }
  ...
  var MissingPDFException = class extends Z {
    constructor(t2) {
      super(t2, "MissingPDFException");
    }
  };
  var UnexpectedResponseException = class extends Z {
    constructor(t2, e2) {
  ...
  var tt = Array.from(Array(256).keys(), ((t2) => t2.toString(16).padStart(2, "0")));
  var Util = class {
    ...
    static getAxialAlignedBoundingBox(t2, e2) {
      const i2 = this.applyTransform(t2, e2), s2 = this.applyTransform(t2.slice(2, 4), e2), n2 = this.applyTransform([t2[0], t2[3]], e2), r2 = this.applyTransform([t2[2], t2[1]], e2);
      return [Math.min(i2[0], s2[0], n2[0], r2[0]), Math.min(i2[1], s2[1], n2[1], r2[1]), Math.max(i2[0], s2[0], n2[0], r2[0]), Math.max(i2[1], s2[1], n2[1], r2[1])];
    }
    ...
    static singularValueDecompose2dScale(t2) {
      const e2 = [t2[0], t2[2], t2[1], t2[3]], i2 = t2[0] * e2[0] + t2[1] * e2[2], s2 = t2[0] * e2[1] + t2[1] * e2[3], n2 = t2[2] * e2[0] + t2[3] * e2[2], r2 = t2[2] * e2[1] + t2[3] * e2[3], a2 = (i2 + r2) / 2, o2 = Math.sqrt((i2 + r2) ** 2 - 4 * (i2 * r2 - n2 * s2)) / 2, l2 = a2 + o2 || 1, h2 = a2 - o2 || 1;
    ...
    static #e(t2, e2, i2, s2, n2, r2, a2, o2, l2, h2, c2, d2) {
      if (Math.abs(l2) < 1e-12) {
        Math.abs(h2) >= 1e-12 && this.#t(t2, e2, i2, s2, n2, r2, a2, o2, -c2 / h2, d2);
        return;
      }
      const u2 = h2 ** 2 - 4 * c2 * l2;
      if (u2 < 0) return;
      const p2 = Math.sqrt(u2), g2 = 2 * l2;
      this.#t(t2, e2, i2, s2, n2, r2, a2, o2, (-h2 + p2) / g2, d2);
      this.#t(t2, e2, i2, s2, n2, r2, a2, o2, (-h2 - p2) / g2, d2);
    }
    static bezierBoundingBox(t2, e2, i2, s2, n2, r2, a2, o2, l2) {
      ...
      } else l2 = [Math.min(t2, a2), Math.min(e2, o2), Math.max(t2, a2), Math.max(e2, o2)];
      this.#e(t2, i2, n2, a2, e2, s2, r2, o2, 3 * (3 * (i2 - n2) - t2 + a2), 6 * (t2 - 2 * i2 + n2), 3 * (i2 - t2), l2);
      this.#e(t2, i2, n2, a2, e2, s2, r2, o2, 3 * (3 * (s2 - r2) - e2 + o2), 6 * (e2 - 2 * s2 + r2), 3 * (s2 - e2), l2);
      return l2;
    }
  };
  var et = null;
  ...
  var PageViewport = class _PageViewport {
    constructor({ viewBox: t2, userUnit: e2, scale: i2, rotation: s2, offsetX: n2 = 0, offsetY: r2 = 0, dontFlip: a2 = false }) {
      ...
      if (0 === h2) {
        ...
        g2 = Math.abs(o2 - t2[0]) * i2 + r2;
        f2 = (t2[3] - t2[1]) * i2;
        m2 = (t2[2] - t2[0]) * i2;
      } else {
        p2 = Math.abs(o2 - t2[0]) * i2 + n2;
        g2 = Math.abs(l2 - t2[1]) * i2 + r2;
        f2 = (t2[2] - t2[0]) * i2;
        m2 = (t2[3] - t2[1]) * i2;
      }
...
`);
  ...
  function getXfaPageViewport(t2, { scale: e2 = 1, rotation: i2 = 0 }) {
    ...
    return new PageViewport({ viewBox: r2, userUnit: 1, scale: e2, rotation: i2 });
  }
  function getRGB(t2) {
    if (t2.startsWith("#")) {
  ...
  var EditorToolbar = class _EditorToolbar {
    ...
    #d(t2) {
      this.#r._focusEventsAllowed = false;
      stopEvent(t2);
    }
    #u(t2) {
      this.#r._focusEventsAllowed = true;
      stopEvent(t2);
    }
    #p(t2) {
      const e2 = this.#r._uiManager._signal;
      t2.addEventListener("focusin", this.#d.bind(this), { capture: true, signal: e2 });
  ...
  var HighlightToolbar = class {
    ...
    #m() {
      ...
      t2.setAttribute("role", "toolbar");
      t2.addEventListener("contextmenu", noContextMenu, { signal: this.#f._signal });
      const e2 = this.#a = document.createElement("div");
    ...
    show(t2, e2, i2) {
      const [s2, n2] = this.#v(e2, i2), { style: r2 } = this.#s ||= this.#m();
      t2.append(this.#s);
  ...
  var ImageManager = class _ImageManager {
    ...
    async #x(t2, e2) {
      ...
      try {
        i2 ||= { bitmap: null, id: `image_${this.#w}_${this.#y++}`, refCounter: 0, isSvg: false };
        let t3;
        if ("string" == typeof e2) {
          i2.url = e2;
    ...
    getFromCanvas(t2, e2) {
      ...
      i2 = { bitmap: s2.transferToImageBitmap(), id: `image_${this.#w}_${this.#y++}`, refCounter: 1, isSvg: false };
      this.#A.set(t2, i2);
      this.#A.set(i2.id, i2);
      return i2;
    }
    ...
    isValidId(t2) {
      return t2.startsWith(`image_${this.#w}_`);
    }
  };
  var CommandManager = class {
    ...
    add({ cmd: t2, undo: e2, post: i2, mustExec: s2, type: n2 = NaN, overwriteIfSameType: r2 = false, keepUndo: a2 = false }) {
      ...
      if (r2 && this.#_[this.#C].type === n2) {
        a2 && (o2.undo = this.#_[this.#C].undo);
        this.#_[this.#C] = o2;
        return;
      }
      const l2 = this.#C + 1;
  ...
  var AnnotationEditorUIManager = class _AnnotationEditorUIManager {
    ...
    #lt = null;
    #ht = null;
    #ct = { isEditing: false, isEmpty: true, hasSomethingToUndo: false, hasSomethingToRedo: false, hasSelectedEditor: false, hasSelectedText: false };
    #dt = [0, 0];
    #ut = null;
    #pt = null;
    #gt = null;
    ...
    constructor(t2, e2, i2, s2, n2, r2, a2, o2, l2, h2, c2, d2, u2) {
    ...
    get highlightColors() {
      return shadow(this, "highlightColors", this.#Y ? new Map(this.#Y.split(",").map(((t2) => t2.split("=").map(((t3) => t3.trim()))))) : null);
    }
    ...
    onSetPreference({ name: t2, value: e2 }) {
      if ("enableNewAltTextWhenAddingImage" === t2) this.#$ = e2;
    }
    ...
    onScaleChanging({ scale: t2 }) {
      ...
      for (const t3 of this.#j) t3.onScaleChanging();
    ...
    highlightSelection(t2 = "") {
      ...
      const { anchorNode: i2, anchorOffset: s2, focusNode: n2, focusOffset: r2 } = e2, a2 = e2.toString(), o2 = this.#yt(e2).closest(".textLayer"), l2 = this.getSelectionBoxes(o2);
      if (!l2) return;
      e2.empty();
      const h2 = this.#wt(o2), c2 = this.#rt === f.NONE, callback = () => {
        h2?.createAndAddNewEditor({ x: 0, y: 0 }, false, { methodOfCreation: t2, boxes: l2, anchorNode: i2, anchorOffset: s2, focusNode: n2, focusOffset: r2, text: a2 });
    ...
    #At() {
      ...
      const e2 = this.#yt(t2).closest(".textLayer"), i2 = this.getSelectionBoxes(e2);
      if (i2) {
    ...
    #xt() {
      ...
      const i2 = this.#yt(t2).closest(".textLayer");
      if (i2) {
        this.#Q?.hide();
        this.#ot = e2;
        this.#_t({ hasSelectedText: true });
        if (this.#rt === f.HIGHLIGHT || this.#rt === f.NONE) {
          this.#rt === f.HIGHLIGHT && this.showAllEditors("highlight", true, true);
          this.#K = this.isShiftKeyDown;
          if (!this.isShiftKeyDown) {
            const t3 = this.#rt === f.HIGHLIGHT ? this.#wt(i2) : null;
            t3?.toggleDrawing();
    ...
    #Et(t2 = "") {
      this.#rt === f.HIGHLIGHT ? this.highlightSelection(t2) : this.#G && this.#At();
    }
    #mt() {
    ...
    blur() {
      ...
      for (const e2 of this.#at) if (e2.div.contains(t2)) {
        this.#it = [e2, t2];
    ...
    dragOver(t2) {
      for (const { type: e2 } of t2.dataTransfer.items) for (const i2 of this.#z) if (i2.isHandlingMimeForPasting(e2)) {
    ...
    drop(t2) {
      for (const e2 of t2.dataTransfer.items) for (const i2 of this.#z) if (i2.isHandlingMimeForPasting(e2.type)) {
    ...
    async paste(t2) {
      ...
      for (const t3 of e2.items) for (const e3 of this.#z) if (e3.isHandlingMimeForPasting(t3.type)) {
    ...
    keydown(t2) {
      ...
      this.#rt === f.NONE || this.isEditorHandlingKeyboard || _AnnotationEditorUIManager._keyboardManager.exec(this, t2);
    }
    keyup(t2) {
    ...
    #_t(t2) {
      if (Object.entries(t2).some((([t3, e2]) => this.#ct[t3] !== e2))) {
        this._eventBus.dispatch("annotationeditorstateschanged", { source: this, details: Object.assign(this.#ct, t2) });
        this.#rt === f.HIGHLIGHT && false === t2.hasSelectedEditor && this.#Rt([[m.HIGHLIGHT_FREE, true]]);
      }
    }
    #Rt(t2) {
    ...
    setEditingState(t2) {
      if (t2) {
        this.#St();
        this.#Mt();
        this.#_t({ isEditing: this.#rt !== f.NONE, isEmpty: this.#It(), hasSomethingToUndo: this.#L.hasSomethingToUndo(), hasSomethingToRedo: this.#L.hasSomethingToRedo(), hasSelectedEditor: false });
      } else {
        this.#Ct();
        this.#Pt();
    ...
    registerEditorTypes(t2) {
      if (!this.#z) {
        this.#z = t2;
        for (const t3 of this.#z) this.#Rt(t3.defaultPropertiesToUpdate);
      }
    }
    getId() {
      return this.#J.id;
    ...
    updateToolbar(t2) {
      t2 !== this.#rt && this._eventBus.dispatch("switchannotationeditormode", { source: this, mode: t2 });
    }
    updateParams(t2, e2) {
      if (this.#z) {
        switch (t2) {
        ...
        for (const i2 of this.#at) i2.updateParams(t2, e2);
        for (const i2 of this.#z) i2.updateDefaultParams(t2, e2);
      }
    }
    ...
    setSelected(t2) {
      ...
      for (const e2 of this.#at) e2 !== t2 && e2.unselect();
      this.#at.clear();
      this.#at.add(t2);
      t2.select();
      this.#Rt(t2.propertiesToUpdate);
    ...
    selectAll() {
      for (const t2 of this.#at) t2.commit();
      this.#kt(this.#D.values());
    }
    unselectAll() {
      if (this.#P) {
        this.#P.commitOrRemove();
        if (this.#rt !== f.NONE) return;
      }
      if (!this.#N?.commitOrRemove() && this.hasSelection) {
        for (const t2 of this.#at) t2.unselect();
        this.#at.clear();
    ...
    translateSelectedEditors(t2, e2, i2 = false) {
      ...
      this.#dt[0] += t2;
      this.#dt[1] += e2;
      const [s2, n2] = this.#dt, r2 = [...this.#at];
      this.#ut && clearTimeout(this.#ut);
      this.#ut = setTimeout((() => {
        this.#ut = null;
        this.#dt[0] = this.#dt[1] = 0;
        this.addCommands({ cmd: () => {
          for (const t3 of r2) this.#D.has(t3.id) && t3.translateInPage(s2, n2);
        }, undo: () => {
          for (const t3 of r2) this.#D.has(t3.id) && t3.translateInPage(-s2, -n2);
        }, mustExec: false });
      }), 1e3);
    ...
    setUpDragSession() {
      if (this.hasSelection) {
        ...
        for (const t2 of this.#at) this.#U.set(t2, { savedX: t2.x, savedY: t2.y, savedPageIndex: t2.pageIndex, newX: 0, newY: 0, newPageIndex: -1 });
      }
    }
    endDragSession() {
      ...
      for (const [{ x: i2, y: s2, pageIndex: n2 }, r2] of t2) {
        ...
        r2.newY = s2;
        r2.newPageIndex = n2;
        e2 ||= i2 !== r2.savedX || s2 !== r2.savedY || n2 !== r2.savedPageIndex;
      }
      if (!e2) return false;
    ...
    dragSelectedEditors(t2, e2) {
      if (this.#U) for (const i2 of this.#U.keys()) i2.drag(t2, e2);
    }
    rebuild(t2) {
      if (null === t2.parent) {
    ...
    renderAnnotationElement(t2) {
      ...
      i2 && (this.#rt !== f.NONE || i2.hasBeenModified) && i2.renderAnnotationElement(t2);
    }
  };
  var AltText = class _AltText {
    ...
    async render() {
      ...
      const onClick = (t3) => {
        ...
        this.#Wt && this.#r._reportTelemetry({ action: "pdfjs.image.alt_text.image_status_label_clicked", data: { label: this.#Xt } });
      };
    ...
    finish() {
      if (this.#Bt) {
        this.#Bt.focus({ focusVisible: this.#jt });
        this.#jt = false;
      }
    }
    isEmpty() {
    ...
    async setGuessedText(t2) {
      if (null === this.#o) {
        this.#Vt = t2;
        this.#$t = await _AltText._l10n.get("pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer", { generatedAltText: t2 });
        this.#Yt();
      }
    }
    toggleAltTextBadge(t2 = false) {
      if (this.#Wt && !this.#o) {
        if (!this.#Gt) {
          const t3 = this.#Gt = document.createElement("div");
          t3.className = "noAltTextBadge";
          this.#r.div.append(t3);
        }
        this.#Gt.classList.toggle("hidden", !t2);
      } else {
        this.#Gt?.remove();
        this.#Gt = null;
      }
    ...
    serialize(t2) {
      let e2 = this.#o;
      t2 || this.#Vt !== e2 || (e2 = this.#$t);
      return { altText: e2, decorative: this.#Nt, guessedText: this.#Vt, textWithDisclaimer: this.#$t };
    }
    get data() {
    ...
    shown() {
      this.#r._reportTelemetry({ action: "pdfjs.image.alt_text.image_status_label_displayed", data: { label: this.#Xt } });
    }
    destroy() {
      this.#Bt?.remove();
      this.#Bt = null;
    ...
    async #Yt() {
      ...
      let e2 = this.#Ut;
      if (!e2) {
        this.#Ut = e2 = document.createElement("span");
        e2.className = "tooltip";
        e2.setAttribute("role", "tooltip");
        e2.id = `alt-text-tooltip-${this.#r.id}`;
      ...
      const i2 = this.#r.getImageForAltText();
  ...
  var TouchManager = class _TouchManager {
    ...
    constructor({ container: t2, isPinchingDisabled: e2 = null, isPinchingStopped: i2 = null, onPinchStart: s2 = null, onPinching: n2 = null, onPinchEnd: r2 = null, signal: a2 }) {
      ...
      this.#ie = AbortSignal.any([a2, this.#ne.signal]);
      t2.addEventListener("touchstart", this.#ae.bind(this), { passive: false, signal: this.#ie });
    }
    ...
    #ae(t2) {
      ...
      if (!this.#re) {
        ...
        const t3 = AbortSignal.any([this.#ie, this.#re.signal]), e3 = this.#pt, i3 = { signal: t3, passive: false };
    ...
    #oe(t2) {
      ...
      let [e2, i2] = t2.touches;
      e2.identifier > i2.identifier && ([e2, i2] = [i2, e2]);
      const { screenX: s2, screenY: n2 } = e2, { screenX: r2, screenY: a2 } = i2, o2 = this.#se, { touch0X: l2, touch0Y: h2, touch1X: c2, touch1Y: d2 } = o2, u2 = c2 - l2, p2 = d2 - h2, g2 = r2 - s2, f2 = a2 - n2, m2 = Math.hypot(g2, f2) || 1, b2 = Math.hypot(u2, p2) || 1;
      if (!this.#Kt && Math.abs(b2 - m2) <= _TouchManager.MIN_TOUCH_DISTANCE_TO_PINCH) return;
      o2.touch0X = s2;
      o2.touch0Y = n2;
      o2.touch1X = r2;
      o2.touch1Y = a2;
  ...
  var AnnotationEditor = class _AnnotationEditor {
    ...
    focusin(t2) {
      this._focusEventsAllowed && (this.#we ? this.#we = false : this.parent.setSelected(this));
    }
    focusout(t2) {
    ...
    translateInPage(t2, e2) {
      this.#Ae ||= [this.x, this.y, this.width, this.height];
    ...
    get _hasBeenMoved() {
      return !!this.#Ae && (this.#Ae[0] !== this.x || this.#Ae[1] !== this.y);
    }
    get _hasBeenResized() {
      return !!this.#Ae && (this.#Ae[2] !== this.width || this.#Ae[3] !== this.height);
    }
    getBaseTranslation() {
    ...
    fixAndSetPosition(t2 = this.rotation) {
      ...
      if (this._mustFixPosition) switch (t2) {
        case 0:
          ...
          r2 = Math.max(0, Math.min(s2 - o2, r2));
          break;
        case 90:
          n2 = Math.max(0, Math.min(i2 - o2, n2));
          r2 = Math.min(s2, Math.max(a2, r2));
          break;
        case 180:
          n2 = Math.min(i2, Math.max(a2, n2));
          r2 = Math.min(s2, Math.max(o2, r2));
          break;
        case 270:
          n2 = Math.min(i2, Math.max(o2, n2));
          r2 = Math.max(0, Math.min(s2 - a2, r2));
      }
      this.x = n2 /= i2;
      this.y = r2 /= s2;
    ...
    fixDims() {
      ...
      this.#ge || n2 || (t2.height = `${(100 * parseFloat(e2) / a2).toFixed(2)}%`);
    }
    ...
    #Oe() {
      ...
      this.#fe.classList.add("resizers");
    ...
    #Ne(t2, e2) {
      ...
      this.#me = [e2.screenX, e2.screenY];
      const n2 = new AbortController(), r2 = this._uiManager.combinedSignal(n2);
      this.parent.togglePointerEvents(false);
      window.addEventListener("pointermove", this.#Be.bind(this, t2), { passive: true, capture: true, signal: r2 });
    ...
    #He() {
      ...
      n2 === t2 && r2 === e2 && a2 === i2 && o2 === s2 || this.addCommands({ cmd: this.#Ue.bind(this, n2, r2, a2, o2), undo: this.#Ue.bind(this, t2, e2, i2, s2), mustExec: true });
    }
    static _round(t2) {
      return Math.round(1e4 * t2) / 1e4;
    }
    #Be(t2, e2) {
      const [i2, s2] = this.parentDimensions, n2 = this.x, r2 = this.y, a2 = this.width, o2 = this.height, l2 = _AnnotationEditor.MIN_SIZE / i2, h2 = _AnnotationEditor.MIN_SIZE / s2, c2 = this.#Le(this.rotation), transf = (t3, e3) => [c2[0] * t3 + c2[2] * e3, c2[1] * t3 + c2[3] * e3], d2 = this.#Le(360 - this.rotation);
      ...
      let v2 = transf(...b2);
      const y2 = _AnnotationEditor._round(n2 + v2[0]), w2 = _AnnotationEditor._round(r2 + v2[1]);
      let A2, x2, _2 = 1, E2 = 1;
      if (e2.fromKeyboard) ({ deltaX: A2, deltaY: x2 } = e2);
      else {
        const { screenX: t3, screenY: i3 } = e2, [s3, n3] = this.#me;
        [A2, x2] = this.screenToPageTranslation(t3 - s3, i3 - n3);
        this.#me[0] = t3;
        this.#me[1] = i3;
      }
      [A2, x2] = (S2 = A2 / i2, C2 = x2 / s2, [d2[0] * S2 + d2[2] * C2, d2[1] * S2 + d2[3] * C2]);
      var S2, C2;
      if (g2) {
        const t3 = Math.hypot(a2, o2);
        _2 = E2 = Math.max(Math.min(Math.hypot(b2[0] - m2[0] - A2, b2[1] - m2[1] - x2) / t3, 1 / a2, 1 / o2), l2 / a2, h2 / o2);
      } else f2 ? _2 = Math.max(l2, Math.min(1, Math.abs(b2[0] - m2[0] - A2))) / a2 : E2 = Math.max(h2, Math.min(1, Math.abs(b2[1] - m2[1] - x2))) / o2;
      const T2 = _AnnotationEditor._round(a2 * _2), M2 = _AnnotationEditor._round(o2 * E2);
      v2 = transf(...p2(T2, M2));
      const P2 = y2 - v2[0], D2 = w2 - v2[1];
      this.#Ae ||= [this.x, this.y, this.width, this.height];
      this.width = T2;
      this.height = M2;
      this.x = P2;
    ...
    render() {
      ...
      this.isResizable && this._uiManager._supportsPinchToZoom && (this.#Pe ||= new TouchManager({ container: this.div, isPinchingDisabled: () => !this.isSelected, onPinchStart: this.#je.bind(this), onPinching: this.#Ge.bind(this), onPinchEnd: this.#Ve.bind(this), signal: this._uiManager._signal }));
    ...
    #Ge(t2, e2, i2) {
      ...
      if (1 === s2) return;
      const n2 = this.#Le(this.rotation), transf = (t3, e3) => [n2[0] * t3 + n2[2] * e3, n2[1] * t3 + n2[3] * e3], [r2, a2] = this.parentDimensions, o2 = this.x, l2 = this.y, h2 = this.width, c2 = this.height, d2 = _AnnotationEditor.MIN_SIZE / r2, u2 = _AnnotationEditor.MIN_SIZE / a2;
      s2 = Math.max(Math.min(s2, 1 / h2, 1 / c2), d2 / h2, u2 / c2);
      const p2 = _AnnotationEditor._round(h2 * s2), g2 = _AnnotationEditor._round(c2 * s2);
      if (p2 === h2 && g2 === c2) return;
      this.#Ae ||= [o2, l2, h2, c2];
      const f2 = transf(h2 / 2, c2 / 2), m2 = _AnnotationEditor._round(o2 + f2[0]), b2 = _AnnotationEditor._round(l2 + f2[1]), v2 = transf(p2 / 2, g2 / 2);
      this.x = m2 - v2[0];
      this.y = b2 - v2[1];
      this.width = p2;
      this.height = g2;
      this.setDims(r2 * p2, a2 * g2);
      this.fixAndSetPosition();
      this._onResizing();
    }
    #Ve() {
    ...
    pointerdown(t2) {
      ...
      if (0 !== t2.button || t2.ctrlKey && e2) t2.preventDefault();
        ...
        this.#we = true;
        this._isDraggable ? this.#$e(t2) : this.#We(t2);
      }
    }
    get isSelected() {
    ...
    #$e(t2) {
      ...
      let i2 = false;
      const s2 = new AbortController(), n2 = this._uiManager.combinedSignal(s2), r2 = { capture: true, passive: false, signal: n2 }, cancelDrag = (t3) => {
        s2.abort();
        this.#ue = null;
        this.#we = false;
      ...
      if (e2) {
        ...
        window.addEventListener("pointermove", ((t3) => {
          ...
          const [r3, a2] = this.screenToPageTranslation(e3 - this.#Ce, s3 - this.#Te);
          this.#Ce = e3;
          this.#Te = s3;
    ...
    #ze() {
      if (this.#ve || !this.div) return;
      this.#ve = new AbortController();
      const t2 = this._uiManager.combinedSignal(this.#ve);
    ...
    makeResizable() {
      if (this.isResizable) {
        this.#Oe();
        this.#fe.classList.remove("hidden");
    ...
    keydown(t2) {
      ...
      if (!this.#ce) {
        ...
        for (const e3 of this.#ce) {
          ...
          e3.addEventListener("focus", this.#Ye.bind(this, n3), { signal: s3 });
      ...
      const n2 = (360 - this.rotation + this.parentRotation) % 360 / 90 * (this.#ce.length / 4);
      if (n2 !== s2) {
        if (n2 < s2) for (let t4 = 0; t4 < s2 - n2; t4++) this.#fe.append(this.#fe.firstChild);
        else if (n2 > s2) for (let t4 = 0; t4 < n2 - s2; t4++) this.#fe.firstChild.before(this.#fe.lastChild);
        let t3 = 0;
        for (const i3 of e2) {
          const e3 = this.#ce[t3++].getAttribute("data-resizer-name");
          i3.setAttribute("data-l10n-id", _AnnotationEditor._l10nResizer[e3]);
        }
      }
      this.#Ke(0);
      this.#Ee = true;
      this.#fe.firstChild.focus({ focusVisible: true });
      t2.preventDefault();
    ...
    #Xe(t2) {
      this.#Ee && t2.relatedTarget?.parentNode !== this.#fe && this.#Re();
    }
    #Ye(t2) {
      this.#ye = this.#Ee ? t2 : "";
    }
    #Ke(t2) {
      if (this.#ce) for (const e2 of this.#ce) e2.tabIndex = t2;
    }
    _resizeWithKeyboard(t2, e2) {
      this.#Ee && this.#Be(this.#ye, { deltaX: t2, deltaY: e2, fromKeyboard: true });
    }
    #Re() {
      this.#Ee = false;
      this.#Ke(-1);
  ...
  var MurmurHash3_64 = class {
    constructor(t2) {
      this.h1 = t2 ? 4294967295 & t2 : rt;
      this.h2 = t2 ? 4294967295 & t2 : rt;
    }
    update(t2) {
      let e2, i2;
      if ("string" == typeof t2) {
      ...
      for (let t3 = 0; t3 < s2; t3++) if (1 & t3) {
        a2 = r2[t3];
        a2 = a2 * c2 & at | a2 * u2 & ot;
        a2 = a2 << 15 | a2 >>> 17;
        a2 = a2 * d2 & at | a2 * p2 & ot;
        l2 ^= a2;
        l2 = l2 << 13 | l2 >>> 19;
        l2 = 5 * l2 + 3864292196;
      } else {
        o2 = r2[t3];
        o2 = o2 * c2 & at | o2 * u2 & ot;
        o2 = o2 << 15 | o2 >>> 17;
        o2 = o2 * d2 & at | o2 * p2 & ot;
        h2 ^= o2;
        h2 = h2 << 13 | h2 >>> 19;
        h2 = 5 * h2 + 3864292196;
      }
    ...
    hexdigest() {
      ...
      t2 ^= e2 >>> 1;
      t2 = 3981806797 * t2 & at | 36045 * t2 & ot;
      e2 = 4283543511 * e2 & at | (2950163797 * (e2 << 16 | t2 >>> 16) & at) >>> 16;
      t2 ^= e2 >>> 1;
      t2 = 444984403 * t2 & at | 60499 * t2 & ot;
      e2 = 3301882366 * e2 & at | (3120437893 * (e2 << 16 | t2 >>> 16) & at) >>> 16;
      t2 ^= e2 >>> 1;
      return (t2 >>> 0).toString(16).padStart(8, "0") + (e2 >>> 0).toString(16).padStart(8, "0");
    }
  };
  var lt = Object.freeze({ map: null, hash: "", transfer: void 0 });
  var AnnotationStorage = class {
    ...
    get serializable() {
      ...
      return t2.size > 0 ? { map: t2, hash: e2.hexdigest(), transfer: i2 } : lt;
    }
    get editorStats() {
      let t2 = null;
      ...
      for (const i2 of this.#Ze.values()) {
        ...
        const r2 = t2[n2] ||= /* @__PURE__ */ new Map();
  ...
  var FontLoader = class {
    ...
    get isSyncFontLoadingSupported() {
      let t2 = false;
      (i || "undefined" != typeof navigator && "string" == typeof navigator?.userAgent && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test(navigator.userAgent)) && (t2 = true);
  ...
  var MessageHandler = class {
    ...
    #ni({ data: t2 }) {
      ...
      if (t2.callback) {
        ...
        if (t2.callback === ht) i2.resolve(t2.data);
        else {
          if (t2.callback !== ct) throw new Error("Unexpected callback case");
      ...
      if (t2.callbackId) {
        ...
        Promise.try(e2, t2.data).then((function(e3) {
          n2.postMessage({ sourceName: i2, targetName: s2, callback: ht, callbackId: t2.callbackId, data: e3 });
        }), (function(e3) {
          n2.postMessage({ sourceName: i2, targetName: s2, callback: ct, callbackId: t2.callbackId, reason: wrapReason(e3) });
        }));
      } else t2.streamId ? this.#ai(t2) : e2(t2.data);
    }
    on(t2, e2) {
    ...
    sendWithStream(t2, e2, i2, s2) {
      ...
      return new ReadableStream({ start: (i3) => {
        ...
        o2.postMessage({ sourceName: r2, targetName: a2, action: t2, streamId: n2, data: e2, desiredSize: i3.desiredSize }, s2);
        return l2.promise;
      }, pull: (t3) => {
        const e3 = Promise.withResolvers();
        this.streamControllers[n2].pullCall = e3;
        o2.postMessage({ sourceName: r2, targetName: a2, stream: mt, streamId: n2, desiredSize: t3.desiredSize });
        return e3.promise;
      }, cancel: (t3) => {
        ...
        o2.postMessage({ sourceName: r2, targetName: a2, stream: dt, streamId: n2, reason: wrapReason(t3) });
        return e3.promise;
      } }, i2);
    }
    #ai(t2) {
      const e2 = t2.streamId, i2 = this.sourceName, s2 = t2.sourceName, n2 = this.comObj, r2 = this, a2 = this.actionHandler[t2.action], o2 = { enqueue(t3, r3 = 1, a3) {
        ...
        n2.postMessage({ sourceName: i2, targetName: s2, stream: gt, streamId: e2, chunk: t3 }, a3);
      }, close() {
        if (!this.isCancelled) {
          this.isCancelled = true;
          n2.postMessage({ sourceName: i2, targetName: s2, stream: pt, streamId: e2 });
      ...
      Promise.try(a2, t2.data, o2).then((function() {
        n2.postMessage({ sourceName: i2, targetName: s2, stream: vt, streamId: e2, success: true });
      }), (function(t3) {
        n2.postMessage({ sourceName: i2, targetName: s2, stream: vt, streamId: e2, reason: wrapReason(t3) });
      }));
    }
    #ri(t2) {
      ...
      switch (t2.stream) {
        ...
        case mt:
          if (!a2) {
            n2.postMessage({ sourceName: i2, targetName: s2, stream: bt, streamId: e2, success: true });
            break;
          }
          ...
          Promise.try(a2.onPull || onFn).then((function() {
            ...
            n2.postMessage({ sourceName: i2, targetName: s2, stream: bt, streamId: e2, reason: wrapReason(t3) });
          }));
          break;
        case gt:
        ...
        case dt:
          ...
          Promise.try(a2.onCancel || onFn, o2).then((function() {
            n2.postMessage({ sourceName: i2, targetName: s2, stream: ut, streamId: e2, success: true });
          }), (function(t3) {
            n2.postMessage({ sourceName: i2, targetName: s2, stream: ut, streamId: e2, reason: wrapReason(t3) });
          }));
  ...
  var RadialAxialShadingPattern = class extends BaseShadingPattern {
    ...
    getPattern(t2, e2, i2, s2) {
      let n2;
      if (s2 === wt || s2 === yt) {
        const r2 = e2.current.getClippedPathBoundingBox(s2, getCurrentTransform(t2)) || [0, 0, 0, 0], a2 = Math.ceil(r2[2] - r2[0]) || 1, o2 = Math.ceil(r2[3] - r2[1]) || 1, l2 = e2.cachedCanvases.getCanvas("pattern", a2, o2), h2 = l2.context;
        h2.clearRect(0, 0, h2.canvas.width, h2.canvas.height);
        h2.beginPath();
        h2.rect(0, 0, h2.canvas.width, h2.canvas.height);
        h2.translate(-r2[0], -r2[1]);
        i2 = Util.transform(i2, [1, 0, 0, 1, r2[0], r2[1]]);
  ...
  function drawTriangle(t2, e2, i2, s2, n2, r2, a2, o2) {
    ...
    if (g2 >= v2) return;
    const y2 = h2[r2], w2 = h2[r2 + 1], A2 = h2[r2 + 2], x2 = h2[a2], _2 = h2[a2 + 1], E2 = h2[a2 + 2], S2 = h2[o2], C2 = h2[o2 + 1], T2 = h2[o2 + 2], M2 = Math.round(g2), P2 = Math.round(v2);
    let D2, k2, R2, I2, L2, O2, N2, B2;
    for (let t3 = M2; t3 <= P2; t3++) {
      ...
      N2 = w2 - (w2 - C2) * e3;
      B2 = A2 - (A2 - T2) * e3;
      const i3 = Math.round(Math.min(D2, L2)), s3 = Math.round(Math.max(D2, L2));
      let n3 = d2 * t3 + 4 * i3;
  ...
  var MeshShadingPattern = class extends BaseShadingPattern {
    ...
    getPattern(t2, e2, i2, s2) {
      applyBoundingBox(t2, this._bbox);
      let n2;
      if (s2 === At) n2 = Util.singularValueDecompose2dScale(getCurrentTransform(t2));
      else {
      ...
      const r2 = this._createMeshCanvas(n2, s2 === At ? null : this._background, e2.cachedCanvases);
      if (s2 !== At) {
  ...
  var TilingPattern = class _TilingPattern {
    ...
    createPatternCanvas(t2) {
      ...
      let y2 = p2, w2 = g2, A2 = false, x2 = false;
      const _2 = Math.ceil(o2 * b2), E2 = Math.ceil(l2 * v2);
      _2 >= Math.ceil(p2 * b2) ? y2 = o2 : A2 = true;
      E2 >= Math.ceil(g2 * v2) ? w2 = l2 : x2 = true;
      const S2 = this.getSizeAndScale(y2, this.ctx.canvas.width, b2), C2 = this.getSizeAndScale(w2, this.ctx.canvas.height, v2), T2 = t2.cachedCanvases.getCanvas("pattern", S2.size, C2.size), M2 = T2.context, P2 = a2.createCanvasGraphics(M2);
      P2.groupLevel = t2.groupLevel;
      this.setFillAndStrokeStyleToContext(P2, s2, r2);
      M2.translate(-S2.scale * h2, -C2.scale * c2);
      P2.transform(S2.scale, 0, 0, C2.scale, 0, 0);
      M2.save();
      this.clipBbox(P2, h2, c2, d2, u2);
      ...
      if (A2 || x2) {
        ...
        A2 && (y2 = o2);
        x2 && (w2 = l2);
        const i3 = this.getSizeAndScale(y2, this.ctx.canvas.width, b2), s3 = this.getSizeAndScale(w2, this.ctx.canvas.height, v2), n3 = i3.size, r3 = s3.size, a3 = t2.cachedCanvases.getCanvas("pattern-workaround", n3, r3), d3 = a3.context, u3 = A2 ? Math.floor(p2 / o2) : 0, f3 = x2 ? Math.floor(g2 / l2) : 0;
        for (let t3 = 0; t3 <= u3; t3++) for (let i4 = 0; i4 <= f3; i4++) d3.drawImage(e3, n3 * t3, r3 * i4, n3, r3, 0, 0, n3, r3);
        return { canvas: a3.canvas, scaleX: i3.scale, scaleY: s3.scale, offsetX: h2, offsetY: c2 };
      }
      return { canvas: T2.canvas, scaleX: S2.scale, scaleY: C2.scale, offsetX: h2, offsetY: c2 };
    }
  ...
  function convertBlackAndWhiteToRGBA({ src: t2, srcPos: e2 = 0, dest: i2, width: s2, height: n2, nonBlackColor: r2 = 4294967295, inverseDecode: a2 = false }) {
    const o2 = util_FeatureTest.isLittleEndian ? 4278190080 : 255, [l2, h2] = a2 ? [r2, o2] : [o2, r2], c2 = s2 >> 3, d2 = 7 & s2, u2 = t2.length;
  ...
  function drawImageAtIntegerCoords(t2, e2, i2, s2, n2, r2, a2, o2, l2, h2) {
    ...
    if (0 === d2 && 0 === u2) {
      const m2 = a2 * c2 + g2, b2 = Math.round(m2), v2 = o2 * p2 + f2, y2 = Math.round(v2), w2 = (a2 + l2) * c2 + g2, A2 = Math.abs(Math.round(w2) - b2) || 1, x2 = (o2 + h2) * p2 + f2, _2 = Math.abs(Math.round(x2) - y2) || 1;
      t2.setTransform(Math.sign(c2), 0, 0, Math.sign(p2), b2, y2);
      t2.drawImage(e2, i2, s2, n2, r2, 0, 0, A2, _2);
      t2.setTransform(c2, d2, u2, p2, g2, f2);
      return [A2, _2];
    }
    if (0 === c2 && 0 === p2) {
      const m2 = o2 * u2 + g2, b2 = Math.round(m2), v2 = a2 * d2 + f2, y2 = Math.round(v2), w2 = (o2 + h2) * u2 + g2, A2 = Math.abs(Math.round(w2) - b2) || 1, x2 = (a2 + l2) * d2 + f2, _2 = Math.abs(Math.round(x2) - y2) || 1;
      t2.setTransform(0, Math.sign(d2), Math.sign(u2), 0, b2, y2);
      t2.drawImage(e2, i2, s2, n2, r2, 0, 0, _2, A2);
      t2.setTransform(c2, d2, u2, p2, g2, f2);
      return [_2, A2];
    }
  ...
  var CanvasExtraState = class {
    ...
    updateRectMinMax(t2, e2) {
      const i2 = Util.applyTransform(e2, t2), s2 = Util.applyTransform(e2.slice(2), t2), n2 = Util.applyTransform([e2[0], e2[3]], t2), r2 = Util.applyTransform([e2[2], e2[1]], t2);
    ...
    getPathBoundingBox(t2 = yt, e2 = null) {
    ...
    getClippedPathBoundingBox(t2 = yt, e2 = null) {
  ...
  function putBinaryImageData(t2, e2) {
    ...
    const i2 = e2.height, s2 = e2.width, n2 = i2 % Et, r2 = (i2 - n2) / Et, a2 = 0 === n2 ? r2 : r2 + 1, o2 = t2.createImageData(s2, Et);
    let l2, h2 = 0;
  ...
  function putBinaryImageMask(t2, e2) {
    ...
    for (let e3 = 0; e3 < a2; e3++) {
      const i3 = e3 < r2 ? Et : n2;
      ({ srcPos: l2 } = convertBlackAndWhiteToRGBA({ src: h2, srcPos: l2, dest: c2, width: s2, height: i3, nonBlackColor: 0 }));
      t2.putImageData(o2, 0, e3 * Et);
    }
  }
  ...
  var St = ["butt", "round", "square"];
  var Ct = ["miter", "round", "bevel"];
  var Tt = {};
  var Mt = {};
  var CanvasGraphics = class _CanvasGraphics {
    ...
    executeOperatorList(t2, e2, i2, s2) {
      ...
      for (; ; ) {
        ...
        p2 = r2[a2];
        if (p2 !== K.dependency) this[p2].apply(this, n2[a2]);
    ...
    _createMaskCanvas(t2) {
      ...
      if ((t2.bitmap || t2.data) && t2.count > 1) {
        ...
        l2 = JSON.stringify(r2 ? a2 : [a2.slice(0, 4), n2]);
        ...
        const i3 = o2.get(l2);
        if (i3 && !r2) {
          return { canvas: i3, offsetX: Math.round(Math.min(a2[0], a2[2]) + a2[4]), offsetY: Math.round(Math.min(a2[1], a2[3]) + a2[5]) };
        }
        h2 = i3;
      }
      if (!h2) {
      ...
      let d2 = Util.transform(a2, [1 / i2, 0, 0, -1 / s2, 0, 0]);
      d2 = Util.transform(d2, [1, 0, 0, 1, 0, -s2]);
      const [u2, p2, g2, f2] = Util.getAxialAlignedBoundingBox([0, 0, i2, s2], d2), m2 = Math.round(g2 - u2) || 1, b2 = Math.round(f2 - p2) || 1, v2 = this.cachedCanvases.getCanvas("fillCanvas", m2, b2), y2 = v2.context, w2 = u2, A2 = p2;
      y2.translate(-w2, -A2);
      y2.transform(...d2);
      if (!h2) {
      ...
      const x2 = Util.transform(getCurrentTransformInverse(y2), [1, 0, 0, 1, -w2, -A2]);
      y2.fillStyle = r2 ? n2.getPattern(e2, this, x2, yt) : n2;
      y2.fillRect(0, 0, i2, s2);
      if (o2 && !r2) {
        this.cachedCanvases.delete("fillCanvas");
        o2.set(l2, v2.canvas);
      }
      return { canvas: v2.canvas, offsetX: Math.round(w2), offsetY: Math.round(A2) };
    }
    setLineWidth(t2) {
    ...
    constructPath(t2, e2, i2) {
      ...
      for (let i3 = 0, u2 = 0, p2 = t2.length; i3 < p2; i3++) switch (0 | t2[i3]) {
        case K.rectangle:
          ...
          c2 || n2.updateRectMinMax(h2, [o2, l2, p3, g2]);
          s2.closePath();
          break;
        case K.moveTo:
          o2 = e2[u2++];
    ...
    fill(t2 = true) {
      ...
      if (this.current.patternFill) {
        e2.save();
        e2.fillStyle = i2.getPattern(e2, this, getCurrentTransformInverse(e2), yt);
        s2 = true;
      }
    ...
    endText() {
      ...
      for (const { transform: e3, x: n2, y: r2, fontSize: a2, path: o2 } of t2) i2.addPath(o2, new DOMMatrix(e3).preMultiplySelf(s2).translate(n2, r2).scale(a2, -a2));
      e2.clip(i2);
      e2.beginPath();
    ...
    setFont(t2, e2) {
      ...
      const r2 = i2.loadedName || "sans-serif", a2 = i2.systemFontInfo?.css || `"${r2}", ${i2.fallbackName}`;
      let o2 = "normal";
    ...
    setTextMatrix(t2, e2, i2, s2, n2, r2) {
      this.current.textMatrix = [t2, e2, i2, s2, n2, r2];
    ...
    paintChar(t2, e2, i2, s2, n2) {
      const r2 = this.ctx, a2 = this.current, o2 = a2.font, l2 = a2.textRenderingMode, h2 = a2.fontSize / a2.fontSizeScale, c2 = l2 & x, d2 = !!(l2 & _), u2 = a2.patternFill && !o2.missingFile, p2 = a2.patternStroke && !o2.missingFile;
      let g2;
      (o2.disableFontFace || d2 || u2 || p2) && (g2 = o2.getPathGenerator(this.commonObjs, t2));
      if (o2.disableFontFace || u2 || p2) {
        r2.save();
        r2.translate(e2, i2);
        r2.scale(h2, -h2);
        if (c2 === v || c2 === w) if (s2) {
          const t3 = r2.getTransform();
          r2.setTransform(...s2);
          r2.fill(this.#di(g2, t3, s2));
        } else r2.fill(g2);
        if (c2 === y || c2 === w) if (n2) {
          const t3 = r2.getTransform();
          r2.setTransform(...n2);
          r2.stroke(this.#di(g2, t3, n2));
        } else {
          r2.lineWidth /= h2;
          r2.stroke(g2);
        }
        ...
        c2 !== v && c2 !== w || r2.fillText(t2, e2, i2);
        c2 !== y && c2 !== w || r2.strokeText(t2, e2, i2);
      }
      if (d2) {
        (this.pendingTextPaths ||= []).push({ transform: getCurrentTransform(r2), x: e2, y: i2, fontSize: h2, path: g2 });
      }
    }
    ...
    showText(t2) {
      ...
      if (e2.patternFill) {
        n2.save();
        const t3 = e2.fillColor.getPattern(n2, this, getCurrentTransformInverse(n2), yt);
      ...
      if (e2.patternStroke) {
        n2.save();
        const t3 = e2.strokeColor.getPattern(n2, this, getCurrentTransformInverse(n2), wt);
        b2 = getCurrentTransform(n2);
        n2.restore();
        n2.strokeStyle = t3;
      }
      let A2 = e2.lineWidth;
      ...
      if (0 === _2 || 0 === A2) {
        ...
        t3 !== y && t3 !== w || (A2 = this.getSinglePixelWidth());
      } else A2 /= _2;
      if (1 !== r2) {
        n2.scale(r2, r2);
        A2 /= r2;
      ...
      for (E2 = 0; E2 < c2; ++E2) {
        ...
        let h3 = false;
        const c3 = (e3.isSpace ? o2 : 0) + a2, v2 = e3.fontChar, y2 = e3.accent;
        let w2, A3, x2 = e3.width;
        if (d2) {
          const t3 = e3.vmetric || p2, i3 = -(e3.vmetric ? t3[1] : 0.5 * x2) * g2, s3 = t3[2] * g2;
          x2 = t3 ? -t3[0] : x2;
          w2 = i3 / r2;
          A3 = (S2 + s3) / r2;
        } else {
        ...
        if (i2.remeasure && x2 > 0) {
          const t3 = 1e3 * n2.measureText(v2).width / s2 * r2;
          if (x2 < t3 && this.isFontSubpixelAAEnabled) {
            const e4 = x2 / t3;
            h3 = true;
            n2.save();
            n2.scale(e4, 1);
            w2 /= e4;
          } else x2 !== t3 && (w2 += (x2 - t3) / 2e3 * s2 / r2);
        }
        if (this.contentVisible && (e3.isInFont || i2.missingFile)) if (f2 && !y2) n2.fillText(v2, w2, A3);
        else {
          this.paintChar(v2, w2, A3, m2, b2);
          if (y2) {
            const t3 = w2 + s2 * y2.offset.x / r2, e4 = A3 - s2 * y2.offset.y / r2;
            this.paintChar(y2.fontChar, t3, e4, m2, b2);
          }
        }
        S2 += d2 ? x2 * g2 - c3 * l2 : x2 * g2 + c3 * l2;
        h3 && n2.restore();
      }
      d2 ? e2.y -= S2 : e2.x += S2 * h2;
      n2.restore();
      this.compose();
    }
    showType3Text(t2) {
      ...
      let p2, g2, f2, m2;
      if (!(i2.textRenderingMode === A) && 0 !== r2) {
        this._cachedScaleForStroking[0] = -1;
        this._cachedGetSinglePixelWidth = null;
        e2.save();
        ...
        for (p2 = 0; p2 < u2; ++p2) {
          ...
          f2 = Util.applyTransform([g2.width, 0], d2)[0] * r2 + n2;
          e2.translate(f2, 0);
          i2.x += f2 * c2;
        }
        e2.restore();
    ...
    shadingFill(t2) {
      ...
      if (s2) {
        const { width: t3, height: i3 } = e2.canvas, [n2, r2, a2, o2] = Util.getAxialAlignedBoundingBox([0, 0, t3, i3], s2);
    ...
    beginGroup(t2) {
      ...
      d2.translate(-r2, -a2);
      d2.transform(...i2);
      if (t2.smask) this.smaskStack.push({ canvas: c2.canvas, context: d2, offsetX: r2, offsetY: a2, subtype: t2.smask.subtype, backdrop: t2.smask.backdrop, transferMap: t2.smask.transferMap || null, startTransformInverse: null });
      else {
        e2.setTransform(1, 0, 0, 1, 0, 0);
        e2.translate(r2, a2);
        e2.save();
    ...
    paintImageMaskXObjectRepeat(t2, e2, i2 = 0, s2 = 0, n2, r2) {
      ...
      for (let t3 = 0, h2 = r2.length; t3 < h2; t3 += 2) {
        const h3 = Util.transform(o2, [e2, i2, s2, n2, r2[t3], r2[t3 + 1]]), [c2, d2] = Util.applyTransform([0, 0], h3);
    ...
    paintImageMaskXObjectGroup(t2) {
      ...
      for (const n2 of t2) {
        ...
        h2.fillStyle = s2 ? i2.getPattern(h2, this, getCurrentTransformInverse(e2), yt) : i2;
    ...
    paintImageXObjectRepeat(t2, e2, i2, s2) {
      ...
      for (let t3 = 0, n3 = s2.length; t3 < n3; t3 += 2) o2.push({ transform: [e2, 0, 0, i2, s2[t3], s2[t3 + 1]], x: 0, y: 0, w: r2, h: a2 });
    ...
    consumePath(t2) {
      ...
      const i2 = this.ctx;
      if (this.pendingClip) {
        e2 || (this.pendingClip === Mt ? i2.clip("evenodd") : i2.clip());
        this.pendingClip = null;
      }
  ...
  for (const t2 in K) void 0 !== CanvasGraphics.prototype[t2] && (CanvasGraphics.prototype[K[t2]] = CanvasGraphics.prototype[t2]);
  ...
  var Pt = /* @__PURE__ */ Symbol("INTERNAL");
  var OptionalContentGroup = class {
    ...
    get visible() {
      if (this.#vi) return this.#yi;
      if (!this.#yi) return false;
      const { print: t2, view: e2 } = this.usage;
      return this.#mi ? "OFF" !== e2?.viewState : !this.#bi || "OFF" !== t2?.printState;
    }
    _setVisible(t2, e2, i2 = false) {
      t2 !== Pt && unreachable("Internal method `_setVisible` called.");
      this.#vi = i2;
      this.#yi = e2;
    }
  };
  var OptionalContentConfig = class {
    ...
    constructor(t2, e2 = o) {
      ...
      if (null !== t2) {
        ...
        this.#_i = t2.order;
        for (const i2 of t2.groups) this.#Ai.set(i2.id, new OptionalContentGroup(e2, i2));
        if ("OFF" === t2.baseState) for (const t3 of this.#Ai.values()) t3._setVisible(Pt, false);
        for (const e3 of t2.on) this.#Ai.get(e3)._setVisible(Pt, true);
        for (const e3 of t2.off) this.#Ai.get(e3)._setVisible(Pt, false);
    ...
    isVisible(t2) {
      if (0 === this.#Ai.size) return true;
      if (!t2) {
        info("Optional content group not defined.");
        return true;
      }
      if ("OCG" === t2.type) {
        if (!this.#Ai.has(t2.id)) {
          warn(`Optional content group not found: ${t2.id}`);
          return true;
        }
        return this.#Ai.get(t2.id).visible;
      }
      if ("OCMD" === t2.type) {
        ...
        if (!t2.policy || "AnyOn" === t2.policy) {
          for (const e2 of t2.ids) {
            ...
            if (this.#Ai.get(e2).visible) return true;
          }
          return false;
        }
        if ("AllOn" === t2.policy) {
          for (const e2 of t2.ids) {
            ...
            if (!this.#Ai.get(e2).visible) return false;
          }
          return true;
        }
        if ("AnyOff" === t2.policy) {
    ...
    setVisibility(t2, e2 = true, i2 = true) {
      const s2 = this.#Ai.get(t2);
      if (s2) {
        if (i2 && e2 && s2.rbGroups.length) for (const e3 of s2.rbGroups) for (const i3 of e3) i3 !== t2 && this.#Ai.get(i3)?._setVisible(Pt, false, true);
        s2._setVisible(Pt, !!e2, true);
        this.#wi = null;
    ...
    getOrder() {
      return this.#Ai.size ? this.#_i ? this.#_i.slice() : [...this.#Ai.keys()] : null;
    }
    getGroups() {
      return this.#Ai.size > 0 ? objectFromMap(this.#Ai) : null;
    }
    getGroup(t2) {
      return this.#Ai.get(t2) || null;
    }
    getHash() {
      if (null !== this.#wi) return this.#wi;
      const t2 = new MurmurHash3_64();
      for (const [e2, i2] of this.#Ai) t2.update(`${e2}:${i2.visible}`);
      return this.#wi = t2.hexdigest();
    }
  };
  ...
  var PDFFetchStreamReader = class {
    constructor(t2) {
      ...
      fetch(s2, createFetchOptions(i2, this._withCredentials, this._abortController)).then(((e3) => {
        ...
        const i3 = e3.headers, { allowRangeRequests: n2, suggestedLength: r2 } = validateRangeRequestCapabilities({ responseHeaders: i3, isHttp: t2.isHttp, rangeChunkSize: this._rangeChunkSize, disableRange: this._disableRange });
  ...
  var PDFFetchStreamRangeReader = class {
    constructor(t2, e2, i2) {
      ...
      const r2 = s2.url;
      fetch(r2, createFetchOptions(n2, this._withCredentials, this._abortController)).then(((e3) => {
        ...
        if (!validateResponseStatus(e3.status)) throw createResponseStatusError(e3.status, r2);
  ...
  var NetworkManager = class {
    ...
    onStateChange(t2, e2) {
      ...
      if (206 === n2) {
        ...
        if (e3) i2.onDone({ begin: parseInt(e3[1], 10), chunk: r2 });
        else {
  ...
  var PDFNetworkStreamFullRequestReader = class {
    ...
    _onHeadersReceived() {
      ...
      const i2 = e2.getAllResponseHeaders(), s2 = new Headers(i2 ? i2.trimStart().replace(/[^\S ]+$/, "").split(/[\r\n]+/).map(((t3) => {
        ...
        return [e3, i3.join(": ")];
      })) : []), { allowRangeRequests: n2, suggestedLength: r2 } = validateRangeRequestCapabilities({ responseHeaders: s2, isHttp: this._manager.isHttp, rangeChunkSize: this._rangeChunkSize, disableRange: this._disableRange });
  ...
  var PDFNodeStream = class {
    constructor(t2) {
      ...
      this.url = (function parseUrlOrPath(t3) {
        if (Dt.test(t3)) return new URL(t3);
  ...
  var TextLayer = class _TextLayer {
    ...
    update({ viewport: t2, onBefore: e2 = null }) {
      ...
      if (i2 !== this.#Li) {
        e2?.();
        this.#Li = i2;
        const t3 = { div: null, properties: null, ctx: _TextLayer.#Yi(this.#Mi) };
        for (const e3 of this.#Hi) {
          t3.properties = this.#Ui.get(e3);
          t3.div = e3;
          this.#Ki(t3);
        }
      }
    ...
    #Xi(t2) {
      if (this.#Ci) return;
      this.#Pi.ctx ??= _TextLayer.#Yi(this.#Mi);
    ...
    #Qi(t2) {
      ...
      this.#Hi.push(e2);
      const s2 = Util.transform(this.#zi, t2.transform);
      let n2 = Math.atan2(s2[1], s2[0]);
      const r2 = this.#Oi[t2.fontName];
      r2.vertical && (n2 += Math.PI / 2);
      let a2 = this.#Ti && r2.fontSubstitution || r2.fontFamily;
      a2 = _TextLayer.fontFamilyMap.get(a2) || a2;
      const o2 = Math.hypot(s2[2], s2[3]), l2 = o2 * _TextLayer.#Ji(a2, this.#Mi);
      let h2, c2;
      if (0 === n2) {
        h2 = s2[4];
        c2 = s2[5] - l2;
      ...
      if (this.#pt === this.#Ii) {
        ...
        u2.top = `${(100 * c2 / this.#Di).toFixed(2)}%`;
      } else {
        u2.left = `${d2}${h2.toFixed(2)}px)`;
        u2.top = `${d2}${c2.toFixed(2)}px)`;
      }
      u2.fontSize = `${d2}${(_TextLayer.#$i * o2).toFixed(2)}px)`;
      u2.fontFamily = a2;
      i2.fontSize = o2;
      e2.setAttribute("role", "presentation");
      e2.textContent = t2.str;
      e2.dir = t2.dir;
      this.#Ti && (e2.dataset.fontName = r2.fontSubstitutionLoadedName || t2.fontName);
    ...
    #Ki(t2) {
      ...
      let r2 = "";
      _TextLayer.#$i > 1 && (r2 = `scale(${1 / _TextLayer.#$i})`);
      if (0 !== i2.canvasWidth && i2.hasText) {
        ...
        l2 > 0 && (r2 = `scaleX(${a2 * this.#Li / l2}) ${r2}`);
      }
    ...
    static cleanup() {
      if (!(this.#Wi.size > 0)) {
        this.#ji.clear();
        for (const { canvas: t2 } of this.#Gi.values()) t2.remove();
        this.#Gi.clear();
      }
    }
    static #Yi(t2 = null) {
      let e2 = this.#Gi.get(t2 ||= "");
      if (!e2) {
    ...
    static #qi() {
      ...
      this.#$i = t2.getBoundingClientRect().height;
      t2.remove();
    }
    static #Ji(t2, e2) {
      const i2 = this.#ji.get(t2);
      if (i2) return i2;
      const s2 = this.#Yi(e2);
      s2.canvas.width = s2.canvas.height = kt;
      this.#Zi(s2, kt, t2);
      ...
      s2.strokeStyle = "red";
      s2.clearRect(0, 0, kt, kt);
      s2.strokeText("g", 0, 0);
      let o2 = s2.getImageData(0, 0, kt, kt).data;
      a2 = 0;
      for (let t3 = o2.length - 1 - 3; t3 >= 0; t3 -= 4) if (o2[t3] > 0) {
        a2 = Math.ceil(t3 / 4 / kt);
        break;
      }
      s2.clearRect(0, 0, kt, kt);
      s2.strokeText("A", 0, kt);
      o2 = s2.getImageData(0, 0, kt, kt).data;
      r2 = 0;
      for (let t3 = 0, e3 = o2.length; t3 < e3; t3 += 4) if (o2[t3] > 0) {
        r2 = kt - Math.floor(t3 / 4 / kt);
        break;
      }
      s2.canvas.width = s2.canvas.height = 0;
  ...
  var Rt = 65536;
  var It = i ? class NodeCanvasFactory extends BaseCanvasFactory {
    _createCanvas(t2, e2) {
  ...
  var Ft = i ? class NodeCMapReaderFactory extends BaseCMapReaderFactory {
    async _fetch(t2) {
      return node_utils_fetchData(t2);
    }
  } : DOMCMapReaderFactory;
  var Lt = i ? class NodeFilterFactory extends BaseFilterFactory {
    ...
    get #as() {
      return this.#rs ||= /* @__PURE__ */ new Map();
    }
    get #os() {
      if (!this.#is) {
        ...
        e2.top = e2.left = 0;
        e2.zIndex = -1;
        const i2 = this.#ns.createElementNS(nt, "svg");
        i2.setAttribute("width", 0);
        i2.setAttribute("height", 0);
        this.#is = this.#ns.createElementNS(nt, "defs");
        t2.append(i2);
        i2.append(this.#is);
    ...
    addFilter(t2) {
      if (!t2) return "none";
      let e2 = this.#A.get(t2);
      if (e2) return e2;
      const [i2, s2, n2] = this.#ls(t2), r2 = 1 === t2.length ? i2 : `${i2}${s2}${n2}`;
      e2 = this.#A.get(r2);
      if (e2) {
        this.#A.set(t2, e2);
        return e2;
      }
      const a2 = `g_${this.#ss}_transfer_map_${this.#y++}`, o2 = this.#hs(a2);
      this.#A.set(t2, o2);
      this.#A.set(r2, o2);
      const l2 = this.#cs(a2);
      this.#ds(i2, s2, n2, l2);
    ...
    addHCMFilter(t2, e2) {
      ...
      const l2 = o2.join(","), h2 = `g_${this.#ss}_hcm_filter`, c2 = n2.filter = this.#cs(h2);
      this.#ds(l2, l2, l2, c2);
      this.#ps(c2);
      ...
      this.#ds(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), c2);
      n2.url = this.#hs(h2);
      return n2.url;
    }
    addAlphaFilter(t2) {
      ...
      const n2 = `g_${this.#ss}_alpha_map_${this.#y++}`, r2 = this.#hs(n2);
      this.#A.set(t2, r2);
      this.#A.set(s2, r2);
      const a2 = this.#cs(n2);
      this.#gs(i2, a2);
    ...
    addLuminosityFilter(t2) {
      let e2, i2, s2 = this.#A.get(t2 || "luminosity");
      if (s2) return s2;
      if (t2) {
        [e2] = this.#ls([t2]);
        i2 = `luminosity_${e2}`;
      ...
      const n2 = `g_${this.#ss}_luminosity_map_${this.#y++}`, r2 = this.#hs(n2);
      this.#A.set(t2, r2);
      this.#A.set(i2, r2);
      const a2 = this.#cs(n2);
      this.#fs(a2);
    ...
    addHighlightHCMFilter(t2, e2, i2, s2, n2) {
      ...
      let h2 = Math.round(0.2126 * o2[0] + 0.7152 * o2[1] + 0.0722 * o2[2]), c2 = Math.round(0.2126 * l2[0] + 0.7152 * l2[1] + 0.0722 * l2[2]), [d2, u2] = [s2, n2].map(this.#us.bind(this));
      ...
      const getSteps = (t3, e3, i3) => {
        ...
        return s3.join(",");
      }, p2 = `g_${this.#ss}_hcm_${t2}_filter`, g2 = a2.filter = this.#cs(p2);
      this.#ps(g2);
      this.#ds(getSteps(d2[0], u2[0], 5), getSteps(d2[1], u2[1], 5), getSteps(d2[2], u2[2], 5), g2);
      a2.url = this.#hs(p2);
      return a2.url;
    }
    destroy(t2 = false) {
    ...
    #fs(t2) {
      const e2 = this.#ns.createElementNS(nt, "feColorMatrix");
    ...
    #cs(t2) {
      const e2 = this.#ns.createElementNS(nt, "filter");
    ...
    #ms(t2, e2, i2) {
      const s2 = this.#ns.createElementNS(nt, e2);
      s2.setAttribute("type", "discrete");
      s2.setAttribute("tableValues", i2);
      t2.append(s2);
    }
    #ds(t2, e2, i2, s2) {
      const n2 = this.#ns.createElementNS(nt, "feComponentTransfer");
      s2.append(n2);
      this.#ms(n2, "feFuncR", t2);
      this.#ms(n2, "feFuncG", e2);
      this.#ms(n2, "feFuncB", i2);
    }
    #gs(t2, e2) {
      const i2 = this.#ns.createElementNS(nt, "feComponentTransfer");
      e2.append(i2);
      this.#ms(i2, "feFuncA", t2);
    }
    #us(t2) {
  ...
  var Ot = i ? class NodeStandardFontDataFactory extends BaseStandardFontDataFactory {
    async _fetch(t2) {
      return node_utils_fetchData(t2);
    }
  ...
  function getDocument(t2 = {}) {
    ...
    })(t2.data) : null, a2 = t2.httpHeaders || null, o2 = true === t2.withCredentials, l2 = t2.password ?? null, h2 = t2.range instanceof PDFDataRangeTransport ? t2.range : null, c2 = Number.isInteger(t2.rangeChunkSize) && t2.rangeChunkSize > 0 ? t2.rangeChunkSize : Rt;
    let d2 = t2.worker instanceof PDFWorker ? t2.worker : null;
    const u2 = t2.verbosity, p2 = "string" != typeof t2.docBaseUrl || isDataScheme(t2.docBaseUrl) ? null : t2.docBaseUrl, g2 = "string" == typeof t2.cMapUrl ? t2.cMapUrl : null, f2 = false !== t2.cMapPacked, m2 = t2.CMapReaderFactory || Ft, b2 = "string" == typeof t2.standardFontDataUrl ? t2.standardFontDataUrl : null, v2 = t2.StandardFontDataFactory || Ot, y2 = true !== t2.stopAtErrors, w2 = Number.isInteger(t2.maxImageSize) && t2.maxImageSize > -1 ? t2.maxImageSize : -1, A2 = false !== t2.isEvalSupported, x2 = "boolean" == typeof t2.isOffscreenCanvasSupported ? t2.isOffscreenCanvasSupported : !i, _2 = "boolean" == typeof t2.isImageDecoderSupported ? t2.isImageDecoderSupported : !i && (util_FeatureTest.platform.isFirefox || !globalThis.chrome), E2 = Number.isInteger(t2.canvasMaxAreaInBytes) ? t2.canvasMaxAreaInBytes : -1, S2 = "boolean" == typeof t2.disableFontFace ? t2.disableFontFace : i, C2 = true === t2.fontExtraProperties, T2 = true === t2.enableXfa, M2 = t2.ownerDocument || globalThis.document, P2 = true === t2.disableRange, D2 = true === t2.disableStream, k2 = true === t2.disableAutoFetch, R2 = true === t2.pdfBug, I2 = t2.CanvasFactory || It, L2 = t2.FilterFactory || Lt, O2 = true === t2.enableHWA, N2 = h2 ? h2.length : t2.length ?? NaN, B2 = "boolean" == typeof t2.useSystemFonts ? t2.useSystemFonts : !i && !S2, H2 = "boolean" == typeof t2.useWorkerFetch ? t2.useWorkerFetch : m2 === DOMCMapReaderFactory && v2 === DOMStandardFontDataFactory && g2 && b2 && isValidFetchUrl(g2, document.baseURI) && isValidFetchUrl(b2, document.baseURI);
    setVerbosityLevel(u2);
    const U2 = { canvasFactory: new I2({ ownerDocument: M2, enableHWA: O2 }), filterFactory: new L2({ docId: s2, ownerDocument: M2 }), cMapReaderFactory: H2 ? null : new m2({ baseUrl: g2, isCompressed: f2 }), standardFontDataFactory: H2 ? null : new v2({ baseUrl: b2 }) };
    if (!d2) {
      const t3 = { verbosity: u2, port: GlobalWorkerOptions.workerPort };
      d2 = t3.port ? PDFWorker.fromPort(t3) : new PDFWorker(t3);
      e2._worker = d2;
    }
    const z2 = { docId: s2, apiVersion: "4.10.38", data: r2, password: l2, disableAutoFetch: k2, rangeChunkSize: c2, length: N2, docBaseUrl: p2, enableXfa: T2, evaluatorOptions: { maxImageSize: w2, disableFontFace: S2, ignoreErrors: y2, isEvalSupported: A2, isOffscreenCanvasSupported: x2, isImageDecoderSupported: _2, canvasMaxAreaInBytes: E2, fontExtraProperties: C2, useSystemFonts: B2, cMapUrl: H2 ? g2 : null, standardFontDataUrl: H2 ? b2 : null } }, j2 = { disableFontFace: S2, fontExtraProperties: C2, ownerDocument: M2, pdfBug: R2, styleElement: null, loadingParams: { disableAutoFetch: k2, enableXfa: T2 } };
    d2.promise.then((function() {
      ...
      const t3 = d2.messageHandler.sendWithPromise("GetDocRequest", z2, r2 ? [r2.buffer] : null);
      let l3;
      if (h2) l3 = new PDFDataTransportStream(h2, { disableRange: P2, disableStream: D2 });
        ...
        l3 = new t4({ url: n2, length: N2, httpHeaders: a2, withCredentials: o2, rangeChunkSize: c2, disableRange: P2, disableStream: D2 });
      }
      return t3.then(((t4) => {
        if (e2.destroyed) throw new Error("Loading aborted");
        if (d2.destroyed) throw new Error("Worker was destroyed");
  ...
  var PDFPageProxy = class {
    ...
    render({ canvasContext: t2, viewport: e2, intent: i2 = "display", annotationMode: s2 = g.ENABLE, transform: n2 = null, background: r2 = null, optionalContentConfigPromise: a2 = null, annotationCanvasMap: o2 = null, pageColors: h2 = null, printAnnotationStorage: c2 = null, isEditing: d2 = false }) {
      ...
      this.#vs = false;
      this.#ys();
      a2 ||= this._transport.getOptionalContentConfig(p2);
      ...
      const complete = (t3) => {
        ...
        (this._maybeCleanupAfterRender || b2) && (this.#vs = true);
        this.#ws(!b2);
        if (t3) {
      ...
      }, v2 = new InternalRenderTask({ callback: complete, params: { canvasContext: t2, viewport: e2, transform: n2, background: r2 }, objs: this.objs, commonObjs: this.commonObjs, annotationCanvasMap: o2, operatorList: m2.operatorList, pageIndex: this._pageIndex, canvasFactory: this._transport.canvasFactory, filterFactory: this._transport.filterFactory, useRequestAnimationFrame: !b2, pdfBug: this._pdfBug, pageColors: h2 });
      (m2.renderTasks ||= /* @__PURE__ */ new Set()).add(v2);
      const y2 = v2.task;
      Promise.all([m2.displayReadyCapability.promise, a2]).then((([t3, e3]) => {
        if (this.destroyed) complete();
          ...
          v2.initializeGraphics({ transparency: t3, optionalContentConfig: e3 });
    ...
    getOperatorList({ intent: t2 = "display", annotationMode: e2 = g.ENABLE, printAnnotationStorage: i2 = null, isEditing: s2 = false } = {}) {
      ...
      if (!a2.opListReadCapability) {
        ...
        (a2.renderTasks ||= /* @__PURE__ */ new Set()).add(r2);
    ...
    cleanup(t2 = false) {
      this.#vs = true;
      const e2 = this.#ws(false);
      t2 && e2 && (this._stats &&= new StatTimer());
      return e2;
    }
    #ws(t2 = false) {
      this.#ys();
      if (!this.#vs || this.destroyed) return false;
      if (t2) {
        this.#bs = setTimeout((() => {
          this.#bs = null;
          this.#ws(false);
  ...
  var LoopbackPort = class {
    ...
    postMessage(t2, e2) {
      ...
      this.#xs.then((() => {
        for (const [t3] of this.#As) t3.call(this, i2);
      }));
    }
    ...
    removeEventListener(t2, e2) {
      const i2 = this.#As.get(e2);
      i2?.();
      this.#As.delete(e2);
    }
    terminate() {
      for (const [, t2] of this.#As) t2?.();
      this.#As.clear();
    }
  };
  ...
  var WorkerTransport = class {
    ...
    getRenderingIntent(t2, e2 = g.ENABLE, i2 = null, s2 = false, n2 = false) {
      ...
      return { renderingIntent: r2, cacheKey: [r2, f2.hash, v2].join("_"), annotationStorageSerializable: f2, modifiedIds: b2 };
    }
    destroy() {
      ...
      t2.on("commonobj", (([e3, i2, s2]) => {
        ...
        switch (i2) {
          case "Font":
            ...
            const o2 = a2 && globalThis.FontInspector?.enabled ? (t3, e4) => globalThis.FontInspector.fontAdded(t3, e4) : null, l2 = new FontFaceObject(s2, { disableFontFace: n2, fontExtraProperties: r2, inspectFont: o2 });
  ...
  var Nt = /* @__PURE__ */ Symbol("INITIAL_DATA");
  var PDFObjects = class {
    #Fs = /* @__PURE__ */ Object.create(null);
    #Ls(t2) {
      return this.#Fs[t2] ||= { ...Promise.withResolvers(), data: Nt };
    }
    get(t2, e2 = null) {
      if (e2) {
        const i3 = this.#Ls(t2);
      ...
      const i2 = this.#Fs[t2];
      if (!i2 || i2.data === Nt) throw new Error(`Requesting object that isn't resolved yet ${t2}.`);
      return i2.data;
    }
    has(t2) {
      const e2 = this.#Fs[t2];
      return !!e2 && e2.data !== Nt;
    }
    delete(t2) {
      const e2 = this.#Fs[t2];
      if (!e2 || e2.data === Nt) return false;
      delete this.#Fs[t2];
      return true;
    }
    resolve(t2, e2 = null) {
  ...
  var InternalRenderTask = class _InternalRenderTask {
    ...
    initializeGraphics({ transparency: t2 = false, optionalContentConfig: e2 }) {
      ...
      this.gfx.beginDrawing({ transform: n2, viewport: s2, transparency: t2, background: r2 });
  ...
  var DOMSVGFactory = class extends BaseSVGFactory {
    _createSVG(t2) {
      return document.createElementNS(nt, t2);
    }
  };
  var XfaLayer = class {
    ...
    static render(t2) {
      ...
      for (; h2.length > 0; ) {
        ...
        r3.append(d2);
        o3.attributes && this.setAttributes({ html: d2, element: o3, storage: e2, intent: n2, linkService: i2 });
  ...
  var AnnotationElement = class _AnnotationElement {
    ...
    updateEdited(t2) {
      ...
      const { rect: e2 } = t2;
      e2 && this.#js(e2);
      this.#zs?.popup.updateEdited(t2);
    }
    resetEdited() {
      if (this.#Hs) {
        this.#js(this.#Hs.rect);
        this.#zs?.popup.resetEdited();
        this.#Hs = null;
      }
    }
    #js(t2) {
    ...
    _createContainer(t2) {
      ...
      this instanceof WidgetAnnotationElement || (n2.tabIndex = Ut);
      const { style: r2 } = n2;
      ...
      const l2 = Util.normalizeRect([e2.rect[0], i2.view[3] - e2.rect[1] + i2.view[1], e2.rect[2], i2.view[3] - e2.rect[3] + i2.view[1]]), { pageWidth: h2, pageHeight: c2, pageX: d2, pageY: u2 } = s2.rawDims;
    ...
    get _commonActions() {
      const setColor = (t2, e2, i2) => {
        ...
        this.annotationStorage.setValue(this.data.id, { [e2]: ColorConverters[`${n2}_rgb`](r2) });
      };
    ...
    _createQuadrilaterals() {
      ...
      for (let i3 = 2, s3 = t2.length; i3 < s3; i3 += 8) {
        ...
        u2.append(p3);
        a2?.push(`<rect vector-effect="non-scaling-stroke" x="${g2}" y="${f2}" width="${m2}" height="${b2}"/>`);
      }
      if (this.#Us) {
        a2.push("</g></svg>')");
    ...
    _createPopup() {
      const { data: t2 } = this, e2 = this.#zs = new PopupAnnotationElement({ data: { color: t2.color, titleObj: t2.titleObj, modificationDate: t2.modificationDate, contentsObj: t2.contentsObj, richText: t2.richText, parentRect: t2.rect, borderStyle: 0, id: `popup_${t2.id}`, rotation: t2.rotation }, parent: this.parent, elements: [this] });
    ...
    _getElementsByName(t2, e2 = null) {
      ...
      if (this._fieldObjects) {
        ...
        if (s2) for (const { page: t3, id: n2, exportValues: r2 } of s2) {
          ...
          !a2 || zt.has(a2) ? i2.push({ id: n2, exportValue: s3, domElement: a2 }) : warn(`_getElementsByName - element not allowed: ${n2}`);
        }
        return i2;
      }
      for (const s2 of document.getElementsByName(t2)) {
        const { exportValue: t3 } = s2, n2 = s2.getAttribute("data-element-id");
        n2 !== e2 && (zt.has(s2) && i2.push({ id: n2, exportValue: t3, domElement: s2 }));
      }
      return i2;
    }
    show() {
  ...
  var LinkAnnotationElement = class extends AnnotationElement {
    ...
    render() {
      ...
      if (t2.url) {
        ...
        this.#Gs(i2, t2.attachment, t2.attachmentDest);
        s2 = true;
    ...
    _bindResetFormAction(t2, e2) {
      ...
      if (this._fieldObjects) t2.onclick = () => {
        ...
        for (const t4 of r2) {
          ...
          i3 && (zt.has(i3) ? i3.dispatchEvent(new Event("resetform")) : warn(`_bindResetFormAction - element not allowed: ${e3}`));
        }
  ...
  var WidgetAnnotationElement = class extends AnnotationElement {
    ...
    _setEventListeners(t2, e2, i2, s2) {
      for (const [n2, r2] of i2) if ("Action" === r2 || this.data.actions?.[r2]) {
        "Focus" !== r2 && "Blur" !== r2 || (e2 ||= { focused: false });
        this._setEventListener(t2, e2, n2, r2, s2);
        "Focus" !== r2 || this.data.actions?.Blur ? "Blur" !== r2 || this.data.actions?.Focus || this._setEventListener(t2, e2, "focus", "Focus", null) : this._setEventListener(t2, e2, "blur", "Blur", null);
      }
    }
          ...
          i2.addEventListener("updatefromsandbox", ((i3) => {
            ...
            const s4 = { value(i4) {
              ...
              if (r3 && !(r3.length <= s5)) {
                ...
                t2.setValue(e2, { value: r3 });
                this.linkService.eventBus?.dispatch("dispatcheventinsandbox", { source: this, detail: { id: e2, name: "Keystroke", value: r3, willCommit: true, commitKey: 1, selStart: n3.selectionStart, selEnd: n3.selectionEnd } });
              }
            } };
    ...
    render() {
      ...
      if (this.enableScripting && this.hasJSActions) {
        ...
        s2.addEventListener("input", ((i3) => {
          ...
          i3.preventDefault();
          this.linkService.eventBus?.dispatch("dispatcheventinsandbox", { source: this, detail: { id: e2, name: "Keystroke", value: a2, change: n3, changeEx: s3, willCommit: false, commitKey: 1, keyDown: false } });
        }));
  ...
  var PopupElement = class {
    ...
    constructor({ container: t2, color: e2, elements: i2, titleObj: s2, modificationDate: n2, contentsObj: r2, richText: a2, parent: o2, rect: l2, parentRect: h2, open: c2 }) {
      ...
      for (const t3 of this.trigger) {
        ...
        t3.addEventListener("mouseenter", this.#Ks);
    ...
    render() {
      ...
      e2.append(i2);
      ({ dir: i2.dir, str: i2.textContent } = this.#cn);
      t2.append(e2);
      if (this.#in) {
    ...
    #qs(t2) {
      t2.altKey || t2.shiftKey || t2.ctrlKey || t2.metaKey || ("Enter" === t2.key || "Escape" === t2.key && this.#an) && this.#Zs();
    }
    ...
    #mn() {
      ...
      let r2 = !!this.#rn, a2 = r2 ? this.#rn : this.#ln;
      for (const t3 of this.#sn) if (!a2 || null !== Util.intersect(t3.data.rect, a2)) {
        a2 = t3.data.rect;
        r2 = true;
        break;
      }
      const o2 = Util.normalizeRect([a2[0], t2[3] - a2[1] + t2[1], a2[2], t2[3] - a2[3] + t2[1]]), l2 = r2 ? a2[2] - a2[0] + 5 : 0, h2 = o2[0] + l2, c2 = o2[1];
      this.#C = [100 * (h2 - s2) / e2, 100 * (c2 - n2) / i2];
    ...
    #Qs() {
      this.#on || this.render();
      if (this.isVisible) this.#an && this.#pt.classList.add("focused");
      else {
        this.#mn();
    ...
    #Ys() {
      ...
      if (!this.#an && this.isVisible) {
        this.#pt.hidden = true;
        this.#pt.style.zIndex = parseInt(this.#pt.style.zIndex) - 1e3;
      }
    }
    forceHide() {
      this.#dn = this.isVisible;
      this.#dn && (this.#pt.hidden = true);
    }
    maybeShow() {
      if (this.#dn) {
        this.#on || this.#Qs();
  ...
  var SquareAnnotationElement = class extends AnnotationElement {
    ...
    render() {
      ...
      const t2 = this.data, { width: e2, height: i2 } = getRectDims(t2.rect), s2 = this.svgFactory.create(e2, i2, true), n2 = t2.borderStyle.width, r2 = this.#vn = this.svgFactory.createElement("svg:rect");
  ...
  var CircleAnnotationElement = class extends AnnotationElement {
    ...
    render() {
      ...
      const t2 = this.data, { width: e2, height: i2 } = getRectDims(t2.rect), s2 = this.svgFactory.create(e2, i2, true), n2 = t2.borderStyle.width, r2 = this.#yn = this.svgFactory.createElement("svg:ellipse");
  ...
  var PolylineAnnotationElement = class extends AnnotationElement {
    ...
    render() {
      ...
      o2 = o2.join(" ");
      const l2 = this.#wn = this.svgFactory.createElement(this.svgElementName);
  ...
  var InkAnnotationElement = class extends AnnotationElement {
    ...
    render() {
      this.container.classList.add(this.containerClassName);
      const { data: { rect: t2, rotation: e2, inkLists: i2, borderStyle: s2, popupRef: n2 } } = this, { transform: r2, width: a2, height: o2 } = this.#_n(e2, t2), l2 = this.svgFactory.create(a2, o2, true), h2 = this.#An = this.svgFactory.createElement("svg:g");
      l2.append(h2);
    ...
    updateEdited(t2) {
      ...
      const { thickness: e2, points: i2, rect: s2 } = t2, n2 = this.#An;
  ...
  var AnnotationLayer = class {
    ...
    async #Dn(t2, e2) {
      const i2 = t2.firstChild || t2, s2 = i2.id = `${st}${e2}`, n2 = await this.#Pn?.getAriaAttributes(s2);
  ...
  var FreeTextEditor = class _FreeTextEditor extends AnnotationEditor {
    ...
    static #Hn(t2) {
      return (t2.nodeType === Node.TEXT_NODE ? t2.nodeValue : t2.innerText).replaceAll(jt, "");
    }
    editorDivPaste(t2) {
      const e2 = t2.clipboardData || window.clipboardData, { types: i2 } = e2;
      if (1 === i2.length && "text/plain" === i2[0]) return;
      t2.preventDefault();
      const s2 = _FreeTextEditor.#zn(e2.getData("text") || "").replaceAll(jt, "\n");
      if (!s2) return;
    ...
    static async deserialize(t2, e2, i2) {
      ...
      if (t2 instanceof FreeTextAnnotationElement) {
        ...
        s2 = t2 = { annotationType: f.FREETEXT, color: Array.from(i3), fontSize: e3, value: l2.join("\n"), position: h2, pageIndex: c2 - 1, rect: n3.slice(0), rotation: r2, id: a2, deleted: false, popupRef: o2 };
      }
      const n2 = await super.deserialize(t2, e2, i2);
      n2.#pn = t2.fontSize;
      n2.#tn = Util.makeHexColor(...t2.color);
      n2.#Rn = _FreeTextEditor.#zn(t2.value);
    ...
    serialize(t2 = false) {
      ...
      const e2 = _FreeTextEditor._internalPadding * this.parentScale, i2 = this.getRect(e2, e2), s2 = AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#tn), n2 = { annotationType: f.FREETEXT, color: s2, fontSize: this.#pn, value: this.#jn(), pageIndex: this.pageIndex, rect: i2, rotation: this.rotation, structTreeParentId: this._structTreeParentId };
      if (t2) return n2;
      if (this.annotationElementId && !this.#Gn(n2)) return null;
  ...
  var Outline = class {
    ...
    static _translate(t2, e2, i2, s2) {
      ...
      for (let n2 = 0, r2 = t2.length; n2 < r2; n2 += 2) {
        s2[n2] = e2 + t2[n2];
        s2[n2 + 1] = i2 + t2[n2 + 1];
      }
      return s2;
  ...
  var FreeDrawOutliner = class _FreeDrawOutliner {
    ...
    static #sr = 8;
    static #nr = 2;
    static #rr = _FreeDrawOutliner.#sr + _FreeDrawOutliner.#nr;
    constructor({ x: t2, y: e2 }, i2, s2, n2, r2, a2 = 0) {
      this.#Vn = i2;
      this.#er = n2 * s2;
      this.#qn = r2;
      this.#Yn.set([NaN, NaN, NaN, NaN, t2, e2], 6);
      this.#Wn = a2;
      this.#Zn = _FreeDrawOutliner.#sr * s2;
      this.#Jn = _FreeDrawOutliner.#rr * s2;
      this.#tr = s2;
      this.#ir.push(t2, e2);
    }
    isEmpty() {
      return isNaN(this.#Yn[8]);
    }
    #ar() {
      const t2 = this.#Yn.subarray(4, 6), e2 = this.#Yn.subarray(16, 18), [i2, s2, n2, r2] = this.#Vn;
      return [(this.#Kn + (t2[0] - e2[0]) / 2 - i2) / n2, (this.#Qn + (t2[1] - e2[1]) / 2 - s2) / r2, (this.#Kn + (e2[0] - t2[0]) / 2 - i2) / n2, (this.#Qn + (e2[1] - t2[1]) / 2 - s2) / r2];
    }
    add({ x: t2, y: e2 }) {
      this.#Kn = t2;
      this.#Qn = e2;
      const [i2, s2, n2, r2] = this.#Vn;
      let [a2, o2, l2, h2] = this.#Yn.subarray(8, 12);
      const c2 = t2 - l2, d2 = e2 - h2, u2 = Math.hypot(c2, d2);
      if (u2 < this.#Jn) return false;
      const p2 = u2 - this.#Zn, g2 = p2 / u2, f2 = g2 * c2, m2 = g2 * d2;
      let b2 = a2, v2 = o2;
      a2 = l2;
      o2 = h2;
      l2 += f2;
      h2 += m2;
      this.#ir?.push(t2, e2);
      const y2 = f2 / p2, w2 = -m2 / p2 * this.#er, A2 = y2 * this.#er;
      this.#Yn.set(this.#Yn.subarray(2, 8), 0);
      this.#Yn.set([l2 + w2, h2 + A2], 4);
      this.#Yn.set(this.#Yn.subarray(14, 18), 12);
      this.#Yn.set([l2 - w2, h2 - A2], 16);
      if (isNaN(this.#Yn[6])) {
        if (0 === this.#Xn.length) {
          this.#Yn.set([a2 + w2, o2 + A2], 2);
          this.#Xn.push(NaN, NaN, NaN, NaN, (a2 + w2 - i2) / n2, (o2 + A2 - s2) / r2);
          this.#Yn.set([a2 - w2, o2 - A2], 14);
          this.#$n.push(NaN, NaN, NaN, NaN, (a2 - w2 - i2) / n2, (o2 - A2 - s2) / r2);
        }
        this.#Yn.set([b2, v2, a2, o2, l2, h2], 6);
        return !this.isEmpty();
      }
      this.#Yn.set([b2, v2, a2, o2, l2, h2], 6);
      if (Math.abs(Math.atan2(v2 - o2, b2 - a2) - Math.atan2(m2, f2)) < Math.PI / 2) {
        [a2, o2, l2, h2] = this.#Yn.subarray(2, 6);
        this.#Xn.push(NaN, NaN, NaN, NaN, ((a2 + l2) / 2 - i2) / n2, ((o2 + h2) / 2 - s2) / r2);
        [a2, o2, b2, v2] = this.#Yn.subarray(14, 18);
        this.#$n.push(NaN, NaN, NaN, NaN, ((b2 + a2) / 2 - i2) / n2, ((v2 + o2) / 2 - s2) / r2);
        return true;
      }
      [b2, v2, a2, o2, l2, h2] = this.#Yn.subarray(0, 6);
      this.#Xn.push(((b2 + 5 * a2) / 6 - i2) / n2, ((v2 + 5 * o2) / 6 - s2) / r2, ((5 * a2 + l2) / 6 - i2) / n2, ((5 * o2 + h2) / 6 - s2) / r2, ((a2 + l2) / 2 - i2) / n2, ((o2 + h2) / 2 - s2) / r2);
      [l2, h2, a2, o2, b2, v2] = this.#Yn.subarray(12, 18);
      this.#$n.push(((b2 + 5 * a2) / 6 - i2) / n2, ((v2 + 5 * o2) / 6 - s2) / r2, ((5 * a2 + l2) / 6 - i2) / n2, ((5 * o2 + h2) / 6 - s2) / r2, ((a2 + l2) / 2 - i2) / n2, ((o2 + h2) / 2 - s2) / r2);
      return true;
    }
    toSVGPath() {
      if (this.isEmpty()) return "";
      const t2 = this.#Xn, e2 = this.#$n;
      if (isNaN(this.#Yn[6]) && !this.isEmpty()) return this.#or();
      const i2 = [];
      i2.push(`M${t2[4]} ${t2[5]}`);
    ...
    #or() {
      const [t2, e2, i2, s2] = this.#Vn, [n2, r2, a2, o2] = this.#ar();
      return `M${(this.#Yn[2] - t2) / i2} ${(this.#Yn[3] - e2) / s2} L${(this.#Yn[4] - t2) / i2} ${(this.#Yn[5] - e2) / s2} L${n2} ${r2} L${a2} ${o2} L${(this.#Yn[16] - t2) / i2} ${(this.#Yn[17] - e2) / s2} L${(this.#Yn[14] - t2) / i2} ${(this.#Yn[15] - e2) / s2} Z`;
    }
    #hr(t2) {
      const e2 = this.#$n;
    ...
    #lr(t2) {
      const [e2, i2, s2, n2] = this.#Vn, r2 = this.#Yn.subarray(4, 6), a2 = this.#Yn.subarray(16, 18), [o2, l2, h2, c2] = this.#ar();
    ...
    getOutlines() {
      const t2 = this.#Xn, e2 = this.#$n, i2 = this.#Yn, [s2, n2, r2, a2] = this.#Vn, o2 = new Float32Array((this.#ir?.length ?? 0) + 2);
      for (let t3 = 0, e3 = o2.length - 2; t3 < e3; t3 += 2) {
        o2[t3] = (this.#ir[t3] - s2) / r2;
        o2[t3 + 1] = (this.#ir[t3 + 1] - n2) / a2;
      }
      o2[o2.length - 2] = (this.#Kn - s2) / r2;
      o2[o2.length - 1] = (this.#Qn - n2) / a2;
      if (isNaN(i2[6]) && !this.isEmpty()) return this.#cr(o2);
      const l2 = new Float32Array(this.#Xn.length + 24 + this.#$n.length);
      let h2 = t2.length;
      ...
      this.#ur(l2, h2);
      return this.newFreeDrawOutline(l2, o2, this.#Vn, this.#tr, this.#Wn, this.#qn);
    }
    #cr(t2) {
      const e2 = this.#Yn, [i2, s2, n2, r2] = this.#Vn, [a2, o2, l2, h2] = this.#ar(), c2 = new Float32Array(36);
      c2.set([NaN, NaN, NaN, NaN, (e2[2] - i2) / n2, (e2[3] - s2) / r2, NaN, NaN, NaN, NaN, (e2[4] - i2) / n2, (e2[5] - s2) / r2, NaN, NaN, NaN, NaN, a2, o2, NaN, NaN, NaN, NaN, l2, h2, NaN, NaN, NaN, NaN, (e2[16] - i2) / n2, (e2[17] - s2) / r2, NaN, NaN, NaN, NaN, (e2[14] - i2) / n2, (e2[15] - s2) / r2], 0);
      return this.newFreeDrawOutline(c2, t2, this.#Vn, this.#tr, this.#Wn, this.#qn);
    }
    #ur(t2, e2) {
      const i2 = this.#$n;
    ...
    #dr(t2, e2) {
      const i2 = this.#Yn.subarray(4, 6), s2 = this.#Yn.subarray(16, 18), [n2, r2, a2, o2] = this.#Vn, [l2, h2, c2, d2] = this.#ar();
      t2.set([NaN, NaN, NaN, NaN, (i2[0] - n2) / a2, (i2[1] - r2) / o2, NaN, NaN, NaN, NaN, l2, h2, NaN, NaN, NaN, NaN, c2, d2, NaN, NaN, NaN, NaN, (s2[0] - n2) / a2, (s2[1] - r2) / o2], e2);
      return e2 + 24;
    }
  };
  var FreeDrawOutline = class extends Outline {
    ...
    toSVGPath() {
      const t2 = [`M${this.#gr[4]} ${this.#gr[5]}`];
      for (let e2 = 6, i2 = this.#gr.length; e2 < i2; e2 += 6) isNaN(this.#gr[e2]) ? t2.push(`L${this.#gr[e2 + 4]} ${this.#gr[e2 + 5]}`) : t2.push(`C${this.#gr[e2]} ${this.#gr[e2 + 1]} ${this.#gr[e2 + 2]} ${this.#gr[e2 + 3]} ${this.#gr[e2 + 4]} ${this.#gr[e2 + 5]}`);
      t2.push("Z");
      return t2.join(" ");
    }
    serialize([t2, e2, i2, s2], n2) {
      ...
      switch (n2) {
        case 0:
          o2 = Outline._rescale(this.#gr, t2, s2, r2, -a2);
          l2 = Outline._rescale(this.#ir, t2, s2, r2, -a2);
          break;
        case 90:
          o2 = Outline._rescaleAndSwap(this.#gr, t2, e2, r2, a2);
          l2 = Outline._rescaleAndSwap(this.#ir, t2, e2, r2, a2);
          break;
        case 180:
          o2 = Outline._rescale(this.#gr, i2, e2, -r2, a2);
          l2 = Outline._rescale(this.#ir, i2, e2, -r2, a2);
          break;
        case 270:
          o2 = Outline._rescaleAndSwap(this.#gr, i2, s2, -r2, -a2);
          l2 = Outline._rescaleAndSwap(this.#ir, i2, s2, -r2, -a2);
      }
    ...
    #fr(t2) {
      ...
      d2[0] = n2 - this.#Wn;
      d2[1] = r2 - this.#Wn;
      d2[2] = a2 - n2 + 2 * this.#Wn;
      d2[3] = o2 - r2 + 2 * this.#Wn;
    ...
    getNewOutline(t2, e2) {
      const [i2, s2, n2, r2] = this.#pr, [a2, o2, l2, h2] = this.#Vn, c2 = n2 * l2, d2 = r2 * h2, u2 = i2 * l2 + a2, p2 = s2 * h2 + o2, g2 = this.newOutliner({ x: this.#ir[0] * c2 + u2, y: this.#ir[1] * d2 + p2 }, this.#Vn, this.#tr, t2, this.#qn, e2 ?? this.#Wn);
      for (let t3 = 2; t3 < this.#ir.length; t3 += 2) g2.add({ x: this.#ir[t3] * c2 + u2, y: this.#ir[t3 + 1] * d2 + p2 });
  ...
  var HighlightOutliner = class {
    ...
    constructor(t2, e2 = 0, i2 = 0, s2 = true) {
      ...
      for (const { x: i3, y: s3, width: h3, height: c3 } of t2) {
        const t3 = Math.floor((i3 - e2) / l2) * l2, d3 = Math.ceil((i3 + h3 + e2) / l2) * l2, u3 = Math.floor((s3 - e2) / l2) * l2, p3 = Math.ceil((s3 + c3 + e2) / l2) * l2, g3 = [t3, u3, p3, true], f2 = [d3, u3, p3, false];
        this.#br.push(g3, f2);
        n2 = Math.min(n2, t3);
        r2 = Math.max(r2, d3);
        a2 = Math.min(a2, u3);
      ...
      const h2 = r2 - n2 + 2 * i2, c2 = o2 - a2 + 2 * i2, d2 = n2 - i2, u2 = a2 - i2, p2 = this.#br.at(s2 ? -1 : -2), g2 = [p2[0], p2[2]];
      for (const t3 of this.#br) {
        const [e3, i3, s3] = t3;
        t3[0] = (e3 - d2) / h2;
        t3[1] = (i3 - u2) / c2;
        t3[2] = (s3 - u2) / c2;
      }
      this.#Vn = new Float32Array([d2, u2, h2, c2]);
      this.#mr = g2;
    }
    getOutlines() {
      this.#br.sort(((t3, e2) => t3[0] - e2[0] || t3[1] - e2[1] || t3[2] - e2[2]));
      const t2 = [];
      for (const e2 of this.#br) if (e2[3]) {
        t2.push(...this.#yr(e2));
        this.#wr(e2);
      } else {
        this.#Ar(e2);
    ...
    #xr(t2) {
      ...
      return new HighlightOutline(s2, this.#Vn, this.#mr);
    }
    #_r(t2) {
      const e2 = this.#vr;
    ...
    #wr([, t2, e2]) {
      const i2 = this.#_r(t2);
      this.#vr.splice(i2, 0, [t2, e2]);
    }
    #Ar([, t2, e2]) {
      const i2 = this.#_r(t2);
      for (let s2 = i2; s2 < this.#vr.length; s2++) {
        const [i3, n2] = this.#vr[s2];
        if (i3 !== t2) break;
        if (i3 === t2 && n2 === e2) {
          this.#vr.splice(s2, 1);
          return;
    ...
    #yr(t2) {
      const [e2, i2, s2] = t2, n2 = [[e2, i2, s2]], r2 = this.#_r(s2);
      for (let t3 = 0; t3 < r2; t3++) {
        const [i3, s3] = this.#vr[t3];
  ...
  var ColorPicker = class _ColorPicker {
    ...
    constructor({ editor: t2 = null, uiManager: e2 = null }) {
      if (t2) {
        this.#Dr = false;
        this.#Ir = m.HIGHLIGHT_COLOR;
        this.#r = t2;
      } else {
        this.#Dr = true;
        this.#Ir = m.HIGHLIGHT_DEFAULT_COLOR;
      }
      this.#f = t2?._uiManager || e2;
      this.#kr = this.#f._eventBus;
      this.#Tr = t2?.color || this.#f?.highlightColors.values().next().value || "#FFFF98";
      _ColorPicker.#Fr ||= Object.freeze({ blue: "pdfjs-editor-colorpicker-blue", green: "pdfjs-editor-colorpicker-green", pink: "pdfjs-editor-colorpicker-pink", red: "pdfjs-editor-colorpicker-red", yellow: "pdfjs-editor-colorpicker-yellow" });
    }
    renderButton() {
      const t2 = this.#Sr = document.createElement("button");
      t2.className = "colorPicker";
      t2.tabIndex = "0";
      t2.setAttribute("data-l10n-id", "pdfjs-editor-colorpicker-button");
      t2.setAttribute("aria-haspopup", true);
      const e2 = this.#f._signal;
      t2.addEventListener("click", this.#Lr.bind(this), { signal: e2 });
      t2.addEventListener("keydown", this.#qs.bind(this), { signal: e2 });
      const i2 = this.#Cr = document.createElement("span");
      i2.className = "swatch";
      i2.setAttribute("aria-hidden", true);
      i2.style.backgroundColor = this.#Tr;
      t2.append(i2);
      return t2;
    }
    renderMainDropdown() {
      const t2 = this.#Mr = this.#Or();
      t2.setAttribute("aria-orientation", "horizontal");
      t2.setAttribute("aria-labelledby", "highlightColorPickerLabel");
      return t2;
    }
    #Or() {
      const t2 = document.createElement("div"), e2 = this.#f._signal;
      t2.addEventListener("contextmenu", noContextMenu, { signal: e2 });
      ...
      for (const [i2, s2] of this.#f.highlightColors) {
        const n2 = document.createElement("button");
        n2.tabIndex = "0";
        n2.role = "option";
        n2.setAttribute("data-color", s2);
        n2.title = i2;
        n2.setAttribute("data-l10n-id", _ColorPicker.#Fr[i2]);
        const r2 = document.createElement("span");
        n2.append(r2);
        r2.className = "swatch";
        r2.style.backgroundColor = s2;
        n2.setAttribute("aria-selected", s2 === this.#Tr);
        n2.addEventListener("click", this.#Nr.bind(this, s2), { signal: e2 });
        t2.append(n2);
      }
      t2.addEventListener("keydown", this.#qs.bind(this), { signal: e2 });
      return t2;
    ...
    #Nr(t2, e2) {
      e2.stopPropagation();
      this.#kr.dispatch("switchannotationeditorparams", { source: this, type: this.#Ir, value: t2 });
    }
    _colorSelectFromKeyboard(t2) {
      if (t2.target === this.#Sr) {
        this.#Lr(t2);
        return;
      }
    ...
    _moveToNext(t2) {
      this.#Br ? t2.target !== this.#Sr ? t2.target.nextSibling?.focus() : this.#Mr.firstChild?.focus() : this.#Lr(t2);
    }
    _moveToPrevious(t2) {
      if (t2.target !== this.#Mr?.firstChild && t2.target !== this.#Sr) {
        this.#Br || this.#Lr(t2);
        t2.target.previousSibling?.focus();
      } else this.#Br && this._hideDropdownFromKeyboard();
    }
    _moveToBeginning(t2) {
      this.#Br ? this.#Mr.firstChild?.focus() : this.#Lr(t2);
    }
    _moveToEnd(t2) {
      this.#Br ? this.#Mr.lastChild?.focus() : this.#Lr(t2);
    }
    #qs(t2) {
    ...
    #Lr(t2) {
      ...
      this.#Pr = 0 === t2.detail;
      if (!this.#Rr) {
        this.#Rr = new AbortController();
        window.addEventListener("pointerdown", this.#h.bind(this), { signal: this.#f.combinedSignal(this.#Rr) });
      }
      if (this.#Mr) {
        this.#Mr.classList.remove("hidden");
        return;
      }
      const e2 = this.#Mr = this.#Or();
      this.#Sr.append(e2);
    }
    #h(t2) {
      this.#Mr?.contains(t2.target) || this.hideDropdown();
    }
    hideDropdown() {
      this.#Mr?.classList.add("hidden");
      this.#Rr?.abort();
      this.#Rr = null;
    }
    get #Br() {
      return this.#Mr && !this.#Mr.classList.contains("hidden");
    }
    _hideDropdownFromKeyboard() {
      if (!this.#Dr) if (this.#Br) {
        this.hideDropdown();
        this.#Sr.focus({ preventScroll: true, focusVisible: this.#Pr });
      } else this.#r?.unselect();
    }
    updateColor(t2) {
      this.#Cr && (this.#Cr.style.backgroundColor = t2);
      if (!this.#Mr) return;
      const e2 = this.#f.highlightColors.values();
      for (const i2 of this.#Mr.children) i2.setAttribute("aria-selected", e2.next().value === t2);
    }
    destroy() {
      this.#Sr?.remove();
      this.#Sr = null;
  ...
  var HighlightEditor = class _HighlightEditor extends AnnotationEditor {
    ...
    constructor(t2) {
      ...
      this.#er = t2.thickness || _HighlightEditor._defaultThickness;
      this.#Yr = t2.opacity || _HighlightEditor._defaultOpacity;
      this.#zr = t2.boxes || null;
      this.#Jr = t2.methodOfCreation || "";
      this.#Qr = t2.text || "";
      this._isDraggable = false;
      if (t2.highlightId > -1) {
        this.#Xr = true;
        ...
        this.#Hr = t2.anchorNode;
        this.#Ur = t2.anchorOffset;
        this.#Vr = t2.focusNode;
        this.#$r = t2.focusOffset;
        this.#ea();
        this.#ta();
    ...
    get telemetryInitialData() {
      return { action: "added", type: this.#Xr ? "free_highlight" : "highlight", color: this._uiManager.highlightColorNames.get(this.color), thickness: this.#er, methodOfCreation: this.#Jr };
    }
    get telemetryFinalData() {
    ...
    #ea() {
      const t2 = new HighlightOutliner(this.#zr, 1e-3);
      this.#qr = t2.getOutlines();
      [this.x, this.y, this.width, this.height] = this.#qr.box;
      const e2 = new HighlightOutliner(this.#zr, 25e-4, 1e-3, "ltr" === this._uiManager.direction);
      this.#Gr = e2.getOutlines();
      const { lastPoint: i2 } = this.#Gr;
      this.#mr = [(i2[0] - this.x) / this.width, (i2[1] - this.y) / this.height];
    }
    #Zr({ highlightOutlines: t2, highlightId: e2, clipPathId: i2 }) {
      this.#qr = t2;
      this.#Gr = t2.getNewOutline(this.#er / 2 + 1.5, 25e-4);
      if (e2 >= 0) {
        this.#y = e2;
        this.#jr = i2;
        this.parent.drawLayer.finalizeDraw(e2, { bbox: t2.box, path: { d: t2.toSVGPath() } });
        this.#Kr = this.parent.drawLayer.drawOutline({ rootClass: { highlightOutline: true, free: true }, bbox: this.#Gr.box, path: { d: this.#Gr.toSVGPath() } }, true);
      } else if (this.parent) {
        const e3 = this.parent.viewport.rotation;
        this.parent.drawLayer.updateProperties(this.#y, { bbox: _HighlightEditor.#ia(this.#qr.box, (e3 - this.rotation + 360) % 360), path: { d: t2.toSVGPath() } });
        this.parent.drawLayer.updateProperties(this.#Kr, { bbox: _HighlightEditor.#ia(this.#Gr.box, e3), path: { d: this.#Gr.toSVGPath() } });
      }
      ...
      const { lastPoint: o2 } = this.#Gr;
      this.#mr = [(o2[0] - s2) / r2, (o2[1] - n2) / a2];
    }
    static initialize(t2, e2) {
      AnnotationEditor.initialize(t2, e2);
    ...
    get propertiesToUpdate() {
      return [[m.HIGHLIGHT_COLOR, this.color || _HighlightEditor._defaultColor], [m.HIGHLIGHT_THICKNESS, this.#er || _HighlightEditor._defaultThickness], [m.HIGHLIGHT_FREE, this.#Xr]];
    }
    #On(t2) {
      const setColorAndOpacity = (t3, e3) => {
        this.color = t3;
        this.#Yr = e3;
        this.parent?.drawLayer.updateProperties(this.#y, { root: { fill: t3, "fill-opacity": e3 } });
        this.#n?.updateColor(t3);
      }, e2 = this.color, i2 = this.#Yr;
    ...
    #sa(t2) {
      const e2 = this.#er, setThickness = (t3) => {
        this.#er = t3;
        this.#na(t3);
      };
    ...
    fixAndSetPosition() {
      return super.fixAndSetPosition(this.#ra());
    }
    getBaseTranslation() {
      return [0, 0];
    }
    getRect(t2, e2) {
      return super.getRect(t2, e2, this.#ra());
    }
    onceAdded(t2) {
    ...
    #na(t2) {
      if (!this.#Xr) return;
      this.#Zr({ highlightOutlines: this.#qr.getNewOutline(t2 / 2) });
      this.fixAndSetPosition();
    ...
    #aa() {
      if (null !== this.#y && this.parent) {
        ...
        this.#y = null;
        this.parent.drawLayer.remove(this.#Kr);
        this.#Kr = null;
      }
    }
    #ta(t2 = this.parent) {
      if (null === this.#y) {
        ({ id: this.#y, clipPathId: this.#jr } = t2.drawLayer.draw({ bbox: this.#qr.box, root: { viewBox: "0 0 1 1", fill: this.color, "fill-opacity": this.#Yr }, rootClass: { highlight: true, free: this.#Xr }, path: { d: this.#qr.toSVGPath() } }, false, true));
        this.#Kr = t2.drawLayer.drawOutline({ rootClass: { highlightOutline: true, free: this.#Xr }, bbox: this.#Gr.box, path: { d: this.#Gr.toSVGPath() } }, this.#Xr);
        this.#Wr && (this.#Wr.style.clipPath = this.#jr);
      }
    }
    static #ia([t2, e2, i2, s2], n2) {
      switch (n2) {
        case 90:
    ...
    rotate(t2) {
      ...
      if (this.#Xr) {
        ...
        i2 = _HighlightEditor.#ia(this.#qr.box, t2);
      } else i2 = _HighlightEditor.#ia([this.x, this.y, this.width, this.height], t2);
      e2.updateProperties(this.#y, { bbox: i2, root: { "data-main-rotation": t2 } });
      e2.updateProperties(this.#Kr, { bbox: _HighlightEditor.#ia(this.#Gr.box, t2), root: { "data-main-rotation": t2 } });
    }
    render() {
      if (this.div) return this.div;
      const t2 = super.render();
      if (this.#Qr) {
        t2.setAttribute("aria-label", this.#Qr);
        t2.setAttribute("role", "mark");
      }
      this.#Xr ? t2.classList.add("free") : this.div.addEventListener("keydown", this.#oa.bind(this), { signal: this._uiManager._signal });
      const e2 = this.#Wr = document.createElement("div");
      t2.append(e2);
      e2.setAttribute("aria-hidden", "true");
      e2.className = "internal";
      e2.style.clipPath = this.#jr;
      const [i2, s2] = this.parentDimensions;
      this.setDims(this.width * i2, this.height * s2);
      bindEvents(this, this.#Wr, ["pointerover", "pointerleave"]);
      this.enableEditing();
      return t2;
    }
    pointerover() {
      this.isSelected || this.parent?.drawLayer.updateProperties(this.#Kr, { rootClass: { hovered: true } });
    }
    pointerleave() {
      this.isSelected || this.parent?.drawLayer.updateProperties(this.#Kr, { rootClass: { hovered: false } });
    }
    #oa(t2) {
    ...
    #la(t2) {
      ...
      t2 ? e2.setPosition(this.#Hr, this.#Ur) : e2.setPosition(this.#Vr, this.#$r);
    }
    select() {
      super.select();
      this.#Kr && this.parent?.drawLayer.updateProperties(this.#Kr, { rootClass: { hovered: false, selected: true } });
    }
    unselect() {
      super.unselect();
      if (this.#Kr) {
        this.parent?.drawLayer.updateProperties(this.#Kr, { rootClass: { selected: false } });
        this.#Xr || this.#la(false);
      }
    }
    get _mustFixPosition() {
      return !this.#Xr;
    ...
    show(t2 = this._isVisible) {
      super.show(t2);
      if (this.parent) {
        this.parent.drawLayer.updateProperties(this.#y, { rootClass: { hidden: !t2 } });
        this.parent.drawLayer.updateProperties(this.#Kr, { rootClass: { hidden: !t2 } });
      }
    }
    #ra() {
      return this.#Xr ? this.rotation : 0;
    }
    #ha() {
      if (this.#Xr) return null;
      const [t2, e2] = this.pageDimensions, [i2, s2] = this.pageTranslation, n2 = this.#zr, r2 = new Float32Array(8 * n2.length);
      let a2 = 0;
    ...
    #ca(t2) {
      return this.#qr.serialize(t2, this.#ra());
    }
    static startHighlighting(t2, e2, { target: i2, x: s2, y: n2 }) {
      ...
      i2.addEventListener("pointermove", this.#ua.bind(this, t2), { signal: c2 });
      this._freeHighlight = new FreeHighlightOutliner({ x: s2, y: n2 }, [r2, a2, o2, l2], t2.scale, this._defaultThickness / 2, e2, 1e-3);
    ...
    static async deserialize(t2, e2, i2) {
      ...
      if (t2 instanceof HighlightAnnotationElement) {
        ...
        s2 = t2 = { annotationType: f.HIGHLIGHT, color: Array.from(a3), opacity: o3, quadPoints: e3, boxes: null, pageIndex: h3 - 1, rect: i3.slice(0), rotation: n3, id: r3, deleted: false, popupRef: l3 };
        ...
        s2 = t2 = { annotationType: f.HIGHLIGHT, color: Array.from(a3), thickness: o3, inkLists: e3, boxes: null, pageIndex: h3 - 1, rect: i3.slice(0), rotation: n3, id: r3, deleted: false, popupRef: l3 };
      }
      const { color: n2, quadPoints: r2, inkLists: a2, opacity: o2 } = t2, l2 = await super.deserialize(t2, e2, i2);
      l2.color = Util.makeHexColor(...n2);
      l2.#Yr = o2 || 1;
      a2 && (l2.#er = t2.thickness);
      ...
      if (r2) {
        ...
        l2.#Xr = true;
        const t3 = a2[0], i3 = { x: t3[0] - d2, y: c2 - (t3[1] - u2) }, s3 = new FreeHighlightOutliner(i3, [0, 0, h2, c2], 1, l2.#er / 2, true, 1e-3);
        ...
        l2.#Zr({ highlightOutlines: s3.getOutlines(), highlightId: n3, clipPathId: r3 });
        l2.#ta();
      }
      return l2;
    }
    serialize(t2 = false) {
      ...
      if (this.deleted) return this.serializeDeleted();
      const e2 = this.getRect(0, 0), i2 = AnnotationEditor._colorManager.convert(this.color), s2 = { annotationType: f.HIGHLIGHT, color: i2, opacity: this.#Yr, thickness: this.#er, quadPoints: this.#ha(), outlines: this.#ca(e2), pageIndex: this.pageIndex, rect: e2, rotation: this.#ra(), structTreeParentId: this._structTreeParentId };
      if (this.annotationElementId && !this.#Gn(s2)) return null;
  ...
  var DrawingOptions = class {
    ...
    toSVGProperties() {
      const t2 = this.#pa;
      this.#pa = /* @__PURE__ */ Object.create(null);
      return { root: t2 };
    }
    reset() {
      this.#pa = /* @__PURE__ */ Object.create(null);
  ...
  var DrawingEditor = class _DrawingEditor extends AnnotationEditor {
    ...
    constructor(t2) {
      super(t2);
      this.#fa = t2.mustBeCommitted || false;
      if (t2.drawOutlines) {
        this.#_a(t2);
        this.#ta();
      }
    }
    #_a({ drawOutlines: t2, drawId: e2, drawingOptions: i2 }) {
      this.#ga = t2;
      this._drawingOptions ||= i2;
      if (e2 >= 0) {
        this._drawId = e2;
        this.parent.drawLayer.finalizeDraw(e2, t2.defaultProperties);
      } else this._drawId = this.#Ea(t2, this.parent);
      this.#Sa(t2.box);
    }
    #Ea(t2, e2) {
    ...
    static updateDefaultParams(t2, e2) {
      ...
      if (this._currentParent) {
        _DrawingEditor.#ma.updateProperty(i2, e2);
    ...
    _updateProperty(t2, e2, i2) {
      const s2 = this._drawingOptions, n2 = s2[e2], setter = (t3) => {
        ...
        const i3 = this.#ga.updateProperty(e2, t3);
        i3 && this.#Sa(i3);
    ...
    _onResizing() {
      this.parent?.drawLayer.updateProperties(this._drawId, _DrawingEditor._mergeSVGProperties(this.#ga.getPathResizingSVGProperties(this.#Ca()), { bbox: this.#Ta() }));
    }
    _onResized() {
      this.parent?.drawLayer.updateProperties(this._drawId, _DrawingEditor._mergeSVGProperties(this.#ga.getPathResizedSVGProperties(this.#Ca()), { bbox: this.#Ta() }));
    }
    _onTranslating(t2, e2) {
      this.parent?.drawLayer.updateProperties(this._drawId, { bbox: this.#Ta(t2, e2) });
    }
    _onTranslated() {
      this.parent?.drawLayer.updateProperties(this._drawId, _DrawingEditor._mergeSVGProperties(this.#ga.getPathTranslatedSVGProperties(this.#Ca(), this.parentDimensions), { bbox: this.#Ta() }));
    }
    _onStartDragging() {
    ...
    #ta(t2 = this.parent) {
      if (null === this._drawId || this.parent !== t2) if (null === this._drawId) {
        ...
        this._drawId = this.#Ea(this.#ga, t2);
    ...
    #Sa(t2) {
      [this.x, this.y, this.width, this.height] = this.#Ma(t2);
      if (this.div) {
        this.fixAndSetPosition();
    ...
    rotate() {
      this.parent && this.parent.drawLayer.updateProperties(this._drawId, _DrawingEditor._mergeSVGProperties({ bbox: this.#Ta() }, this.#ga.updateRotation((this.parentRotation - this.rotation + 360) % 360)));
    }
    onScaleChanging() {
      this.parent && this.#Sa(this.#ga.updateParentDimensions(this.parentDimensions, this.parent.scale));
    }
    ...
    static startDrawing(t2, e2, i2, s2) {
      ...
      if (_DrawingEditor.#wa && _DrawingEditor.#wa !== l2) return;
      const { viewport: { rotation: h2 } } = t2, { width: c2, height: d2 } = n2.getBoundingClientRect(), u2 = _DrawingEditor.#ba = new AbortController(), p2 = t2.combinedSignal(u2);
      _DrawingEditor.#ya ||= o2;
      _DrawingEditor.#wa ??= l2;
      window.addEventListener("pointerup", ((t3) => {
        _DrawingEditor.#ya === t3.pointerId ? this._endDraw(t3) : _DrawingEditor.#Aa?.delete(t3.pointerId);
      }), { signal: p2 });
      window.addEventListener("pointercancel", ((t3) => {
        _DrawingEditor.#ya === t3.pointerId ? this._currentParent.endDrawingSession() : _DrawingEditor.#Aa?.delete(t3.pointerId);
      }), { signal: p2 });
      window.addEventListener("pointerdown", ((t3) => {
        if (_DrawingEditor.#wa === t3.pointerType) {
          (_DrawingEditor.#Aa ||= /* @__PURE__ */ new Set()).add(t3.pointerId);
          if (_DrawingEditor.#ma.isCancellable()) {
            _DrawingEditor.#ma.removeLastElement();
            _DrawingEditor.#ma.isEmpty() ? this._currentParent.endDrawingSession(true) : this._endDraw(null);
          }
        }
      ...
      n2.addEventListener("touchmove", ((t3) => {
        t3.timeStamp === _DrawingEditor.#xa && stopEvent(t3);
      }), { signal: p2 });
      t2.toggleDrawing();
      e2._editorUndoBar?.hide();
      if (_DrawingEditor.#ma) t2.drawLayer.updateProperties(this._currentDrawId, _DrawingEditor.#ma.startNew(r2, a2, c2, d2, h2));
      else {
        e2.updateUIForDefaultProperties(this);
        _DrawingEditor.#ma = this.createDrawerInstance(r2, a2, c2, d2, h2);
        _DrawingEditor.#va = this.getDefaultDrawingOptions();
        this._currentParent = t2;
        ({ id: this._currentDrawId } = t2.drawLayer.draw(this._mergeSVGProperties(_DrawingEditor.#va.toSVGProperties(), _DrawingEditor.#ma.defaultSVGProperties), true, false));
      }
    }
    static _drawMove(t2) {
      _DrawingEditor.#xa = -1;
      if (!_DrawingEditor.#ma) return;
      const { offsetX: e2, offsetY: i2, pointerId: s2 } = t2;
      if (_DrawingEditor.#ya === s2) if (_DrawingEditor.#Aa?.size >= 1) this._endDraw(t2);
      else {
        this._currentParent.drawLayer.updateProperties(this._currentDrawId, _DrawingEditor.#ma.add(e2, i2));
        _DrawingEditor.#xa = t2.timeStamp;
        stopEvent(t2);
      }
    }
    static _cleanup(t2) {
      if (t2) {
        ...
        _DrawingEditor.#ma = null;
        _DrawingEditor.#va = null;
        _DrawingEditor.#wa = null;
        _DrawingEditor.#xa = NaN;
      }
      if (_DrawingEditor.#ba) {
        _DrawingEditor.#ba.abort();
        _DrawingEditor.#ba = null;
        _DrawingEditor.#ya = NaN;
        _DrawingEditor.#Aa = null;
      }
    }
    static _endDraw(t2) {
      ...
      if (e2) {
        ...
        this._cleanup(false);
        t2 && e2.drawLayer.updateProperties(this._currentDrawId, _DrawingEditor.#ma.end(t2.offsetX, t2.offsetY));
        if (this.supportMultipleDrawings) {
          const t3 = _DrawingEditor.#ma, i2 = this._currentDrawId, s2 = t3.getLastElement();
          e2.addCommands({ cmd: () => {
    ...
    static endDrawing(t2) {
      ...
      if (!_DrawingEditor.#ma.isEmpty()) {
        const { pageDimensions: [i2, s2], scale: n2 } = e2, r2 = e2.createAndAddNewEditor({ offsetX: 0, offsetY: 0 }, false, { drawId: this._currentDrawId, drawOutlines: _DrawingEditor.#ma.getOutlines(i2 * n2, s2 * n2, n2, this._INNER_MARGIN), drawingOptions: _DrawingEditor.#va, mustBeCommitted: !t2 });
        this._cleanup(true);
        return r2;
      }
    ...
    serializeDraw(t2) {
      ...
      return this.#ga.serialize([e2, i2, s2, n2], t2);
    }
    renderAnnotationElement(t2) {
      t2.updateEdited({ rect: this.getRect(0, 0) });
      return null;
  ...
  var InkDrawOutliner = class {
    ...
    constructor(t2, e2, i2, s2, n2, r2) {
      ...
      this.#ir = [t2, e2];
      this.#Pa = [{ line: a2, points: this.#ir }];
      this.#Yn.set(a2, 0);
    }
    updateProperty(t2, e2) {
      "stroke-width" === t2 && (this.#er = e2);
    }
    #Fa(t2, e2) {
      return Outline._normalizePoint(t2, e2, this.#Ra, this.#Ia, this.#Fi);
    }
    isEmpty() {
      return !this.#Pa || 0 === this.#Pa.length;
    }
    isCancellable() {
      return this.#ir.length <= 10;
    }
    add(t2, e2) {
      [t2, e2] = this.#Fa(t2, e2);
      const [i2, s2, n2, r2] = this.#Yn.subarray(2, 6), a2 = t2 - n2, o2 = e2 - r2;
      if (Math.hypot(this.#Ra * a2, this.#Ia * o2) <= 2) return null;
      this.#ir.push(t2, e2);
      if (isNaN(i2)) {
        this.#Yn.set([n2, r2, t2, e2], 2);
        this.#bn.push(NaN, NaN, NaN, NaN, t2, e2);
        return { path: { d: this.toSVGPath() } };
      }
      isNaN(this.#Yn[0]) && this.#bn.splice(6, 6);
      this.#Yn.set([i2, s2, n2, r2, t2, e2], 0);
      this.#bn.push(...Outline.createBezierPoints(i2, s2, n2, r2, t2, e2));
      return { path: { d: this.toSVGPath() } };
    }
    end(t2, e2) {
      const i2 = this.add(t2, e2);
      return i2 || (2 === this.#ir.length ? { path: { d: this.toSVGPath() } } : null);
    }
    ...
    setLastElement(t2) {
      if (!this.#Pa) return this.#Er.setLastElement(t2);
      this.#Pa.push(t2);
      this.#bn = t2.line;
      this.#ir = t2.points;
      this.#ka = 0;
    ...
    removeLastElement() {
      if (!this.#Pa) return this.#Er.removeLastElement();
      this.#Pa.pop();
      this.#Da = "";
      for (let t2 = 0, e2 = this.#Pa.length; t2 < e2; t2++) {
        const { line: e3, points: i2 } = this.#Pa[t2];
        this.#bn = e3;
        this.#ir = i2;
        this.#ka = 0;
        this.toSVGPath();
      }
      return { path: { d: this.#Da } };
    }
    toSVGPath() {
      const t2 = Outline.svgRound(this.#bn[4]), e2 = Outline.svgRound(this.#bn[5]);
      if (2 === this.#ir.length) {
        this.#Da = `${this.#Da} M ${t2} ${e2} Z`;
        return this.#Da;
      }
      if (this.#ir.length <= 6) {
        const i3 = this.#Da.lastIndexOf("M");
        this.#Da = `${this.#Da.slice(0, i3)} M ${t2} ${e2}`;
        this.#ka = 6;
      }
      if (4 === this.#ir.length) {
        const t3 = Outline.svgRound(this.#bn[10]), e3 = Outline.svgRound(this.#bn[11]);
        this.#Da = `${this.#Da} L ${t3} ${e3}`;
        this.#ka = 12;
        return this.#Da;
      }
      const i2 = [];
      ...
      for (let t3 = this.#ka, e3 = this.#bn.length; t3 < e3; t3 += 6) {
        const [e4, s2, n2, r2, a2, o2] = this.#bn.slice(t3, t3 + 6).map(Outline.svgRound);
        i2.push(`C${e4} ${s2} ${n2} ${r2} ${a2} ${o2}`);
      }
      this.#Da += i2.join(" ");
      this.#ka = this.#bn.length;
      return this.#Da;
    }
    getOutlines(t2, e2, i2, s2) {
      const n2 = this.#Pa.at(-1);
      n2.line = new Float32Array(n2.line);
      n2.points = new Float32Array(n2.points);
      this.#Er.build(this.#Pa, t2, e2, i2, this.#Fi, this.#er, s2);
      this.#Yn = null;
      this.#bn = null;
      this.#Pa = null;
      this.#Da = null;
  ...
  var InkDrawOutline = class _InkDrawOutline extends Outline {
    ...
    serialize([t2, e2, i2, s2], n2) {
      const r2 = [], a2 = [], [o2, l2, h2, c2] = this.#Ba();
      let d2, u2, p2, g2, f2, m2, b2, v2, y2;
      switch (this.#Fi) {
        case 0:
          y2 = Outline._rescale;
          d2 = t2;
      ...
      for (const { line: t3, points: e3 } of this.#Pa) {
        r2.push(y2(t3, d2, u2, p2, g2, n2 ? new Array(t3.length) : null));
        a2.push(y2(e3, d2, u2, p2, g2, n2 ? new Array(e3.length) : null));
      }
      return { lines: r2, points: a2, rect: [f2, m2, b2, v2] };
    }
      ...
      if (!r2) {
        ...
        for (const t3 of a2) {
          ...
          for (let r3 = 4; r3 < e3; r3 += 2) {
            ...
            i3.set(Outline.createBezierPoints(s3, n3, a3, o3, e4, l3), 3 * (r3 - 2));
            [s3, n3, a3, o3] = [a3, o3, e4, l3];
          }
        }
      }
      for (let t3 = 0, e3 = r2.length; t3 < e3; t3++) h2.push({ line: g2(r2[t3].map(((t4) => t4 ?? NaN)), c2, d2, u2, p2), points: g2(a2[t3].map(((t4) => t4 ?? NaN)), c2, d2, u2, p2) });
      const f2 = new _InkDrawOutline();
      f2.build(h2, i2, s2, 1, o2, l2, n2);
      return f2;
    }
    #Ha(t2 = this.#er) {
      const e2 = this.#Wn + t2 / 2 * this.#Oa;
      return this.#Fi % 180 == 0 ? [e2 / this.#Ra, e2 / this.#Ia] : [e2 / this.#Ia, e2 / this.#Ra];
    }
    #Ba() {
      const [t2, e2, i2, s2] = this.#pr, [n2, r2] = this.#Ha(0);
      return [t2 + n2, e2 + r2, i2 - 2 * n2, s2 - 2 * r2];
    }
    #Na() {
      const t2 = this.#pr = new Float32Array([1 / 0, 1 / 0, -1 / 0, -1 / 0]);
      for (const { line: e3 } of this.#Pa) {
        if (e3.length <= 12) {
        ...
        let i3 = e3[4], s2 = e3[5];
        for (let n2 = 6, r2 = e3.length; n2 < r2; n2 += 6) {
          const [r3, a2, o2, l2, h2, c2] = e3.subarray(n2, n2 + 6);
          Util.bezierBoundingBox(i3, s2, r3, a2, o2, l2, h2, c2, t2);
          i3 = h2;
          s2 = c2;
        }
      }
    ...
    updateProperty(t2, e2) {
      return "stroke-width" === t2 ? this.#sa(e2) : null;
    }
    #sa(t2) {
      const [e2, i2] = this.#Ha();
      this.#er = t2;
      const [s2, n2] = this.#Ha(), [r2, a2] = [s2 - e2, n2 - i2], o2 = this.#pr;
      o2[0] -= r2;
      o2[1] -= a2;
      o2[2] += 2 * r2;
      o2[3] += 2 * a2;
    ...
    updateParentDimensions([t2, e2], i2) {
      ...
      this.#Ia = e2;
      this.#Oa = i2;
      const [r2, a2] = this.#Ha(), o2 = r2 - s2, l2 = a2 - n2, h2 = this.#pr;
      h2[0] -= o2;
      h2[1] -= l2;
      h2[2] += 2 * o2;
      h2[3] += 2 * l2;
    ...
    get viewBox() {
      return this.#pr.map(Outline.svgRound).join(" ");
    }
    ...
    get rotationTransform() {
      ...
      return `matrix(${i2} ${s2} ${n2} ${r2} ${Outline.svgRound(a2)} ${Outline.svgRound(o2)})`;
    }
    getPathResizingSVGProperties([t2, e2, i2, s2]) {
      const [n2, r2] = this.#Ha(), [a2, o2, l2, h2] = this.#pr;
      if (Math.abs(l2 - n2) <= Outline.PRECISION || Math.abs(h2 - r2) <= Outline.PRECISION) {
        const n3 = t2 + i2 / 2 - (a2 + l2 / 2), r3 = e2 + s2 / 2 - (o2 + h2 / 2);
        return { path: { "transform-origin": `${Outline.svgRound(t2)} ${Outline.svgRound(e2)}`, transform: `${this.rotationTransform} translate(${n3} ${r3})` } };
      }
      const c2 = (i2 - 2 * n2) / (l2 - 2 * n2), d2 = (s2 - 2 * r2) / (h2 - 2 * r2), u2 = l2 / i2, p2 = h2 / s2;
      return { path: { "transform-origin": `${Outline.svgRound(a2)} ${Outline.svgRound(o2)}`, transform: `${this.rotationTransform} scale(${u2} ${p2}) translate(${Outline.svgRound(n2)} ${Outline.svgRound(r2)}) scale(${c2} ${d2}) translate(${Outline.svgRound(-n2)} ${Outline.svgRound(-r2)})` } };
    }
    getPathResizedSVGProperties([t2, e2, i2, s2]) {
      const [n2, r2] = this.#Ha(), a2 = this.#pr, [o2, l2, h2, c2] = a2;
      a2[0] = t2;
      a2[1] = e2;
      a2[2] = i2;
      a2[3] = s2;
      if (Math.abs(h2 - n2) <= Outline.PRECISION || Math.abs(c2 - r2) <= Outline.PRECISION) {
        const n3 = t2 + i2 / 2 - (o2 + h2 / 2), r3 = e2 + s2 / 2 - (l2 + c2 / 2);
        for (const { line: t3, points: e3 } of this.#Pa) {
          Outline._translate(t3, n3, r3, t3);
          Outline._translate(e3, n3, r3, e3);
        }
      ...
      if (1 !== d2 || 1 !== u2 || 0 !== p2 || 0 !== g2) for (const { line: t3, points: e3 } of this.#Pa) {
    ...
    getPathTranslatedSVGProperties([t2, e2], i2) {
      const [s2, n2] = i2, r2 = this.#pr, a2 = t2 - r2[0], o2 = e2 - r2[1];
      if (this.#Ra === s2 && this.#Ia === n2) for (const { line: t3, points: e3 } of this.#Pa) {
        Outline._translate(t3, a2, o2, t3);
        Outline._translate(e3, a2, o2, e3);
      }
      else {
        const t3 = this.#Ra / s2, e3 = this.#Ia / n2;
        this.#Ra = s2;
        this.#Ia = n2;
        for (const { line: i3, points: s3 } of this.#Pa) {
          Outline._rescale(i3, a2, o2, t3, e3, i3);
          Outline._rescale(s3, a2, o2, t3, e3, s3);
        }
        r2[2] *= t3;
        r2[3] *= e3;
      }
  ...
  var InkDrawingOptions = class _InkDrawingOptions extends DrawingOptions {
    ...
    updateSVGProperty(t2, e2) {
      if ("stroke-width" === t2) {
        ...
        e2 *= this.#Ua.realScale;
      }
      super.updateSVGProperty(t2, e2);
    }
    clone() {
      const t2 = new _InkDrawingOptions(this.#Ua);
      t2.updateAll(this);
      return t2;
    }
  };
  var InkEditor = class _InkEditor extends DrawingEditor {
    ...
    static deserializeDraw(t2, e2, i2, s2, n2, r2) {
      return InkDrawOutline.deserialize(t2, e2, i2, s2, n2, r2);
    }
    static async deserialize(t2, e2, i2) {
      let s2 = null;
      if (t2 instanceof InkAnnotationElement) {
        const { data: { inkLists: e3, rect: i3, rotation: n3, id: r2, color: a2, opacity: o2, borderStyle: { rawWidth: l2 }, popupRef: h2 }, parent: { page: { pageNumber: c2 } } } = t2;
        s2 = t2 = { annotationType: f.INK, color: Array.from(a2), thickness: l2, opacity: o2, paths: { points: e3 }, boxes: null, pageIndex: c2 - 1, rect: i3.slice(0), rotation: n3, id: r2, deleted: false, popupRef: h2 };
      }
      const n2 = await super.deserialize(t2, e2, i2);
      n2.annotationElementId = t2.id || null;
      n2._initialData = s2;
    ...
    serialize(t2 = false) {
      if (this.isEmpty()) return null;
      if (this.deleted) return this.serializeDeleted();
      const { lines: e2, points: i2, rect: s2 } = this.serializeDraw(t2), { _drawingOptions: { stroke: n2, "stroke-opacity": r2, "stroke-width": a2 } } = this, o2 = { annotationType: f.INK, color: AnnotationEditor._colorManager.convert(n2), opacity: r2, thickness: a2, paths: { lines: e2, points: i2 }, pageIndex: this.pageIndex, rect: s2, rotation: this.rotation, structTreeParentId: this._structTreeParentId };
      if (t2) return o2;
      if (this.annotationElementId && !this.#Gn(o2)) return null;
  ...
  var StampEditor = class _StampEditor extends AnnotationEditor {
    ...
    constructor(t2) {
      ...
      this.#Va = t2.bitmapUrl;
      this.#$a = t2.bitmapFile;
    }
    static initialize(t2, e2) {
      AnnotationEditor.initialize(t2, e2);
    }
    ...
    static paste(t2, e2) {
      e2.pasteEditor(f.STAMP, { bitmapFile: t2.getAsFile() });
    }
    altTextFinish() {
    ...
    #Za() {
      ...
      if (this.#qa) if (this._uiManager.useNewAltTextWhenAddingImage && this._uiManager.useNewAltTextFlow && this.#za) {
        this._editToolbar.hide();
        this._uiManager.editAltText(this, true);
      } else {
        if (!this._uiManager.useNewAltTextWhenAddingImage && this._uiManager.useNewAltTextFlow && this.#za) {
    ...
    #to() {
      if (this.#ja) {
        ...
        this._uiManager.imageManager.getFromId(this.#ja).then(((t3) => this.#Qa(t3, true))).finally((() => this.#Za()));
        return;
      }
      if (this.#Va) {
        const t3 = this.#Va;
        this.#Va = null;
        this._uiManager.enableWaiting(true);
        this.#Ga = this._uiManager.imageManager.getFromUrl(t3).then(((t4) => this.#Qa(t4))).finally((() => this.#Za()));
        return;
      }
      if (this.#$a) {
        const t3 = this.#$a;
        this.#$a = null;
        this._uiManager.enableWaiting(true);
        this.#Ga = this._uiManager.imageManager.getFromFile(t3).then(((t4) => this.#Qa(t4))).finally((() => this.#Za()));
        return;
      }
    ...
    remove() {
      if (this.#ja) {
        this.#za = null;
        this._uiManager.imageManager.deleteId(this.#ja);
        this.#qa?.remove();
        this.#qa = null;
        if (this.#Xa) {
          clearTimeout(this.#Xa);
          this.#Xa = null;
        }
      }
      super.remove();
    ...
    rebuild() {
      if (this.parent) {
        super.rebuild();
        if (null !== this.div) {
          this.#ja && null === this.#qa && this.#to();
          this.isAttachedToDOM || this.parent.add(this);
        }
      } else this.#ja && this.#to();
    }
    onceAdded(t2) {
      this._isDraggable = true;
      t2 && this.div.focus();
    ...
    isEmpty() {
      return !(this.#Ga || this.#za || this.#Va || this.#$a || this.#ja);
    }
    get isResizable() {
      return true;
    }
    ...
    onScaleChanging() {
      if (!this.parent) return;
      null !== this.#Xa && clearTimeout(this.#Xa);
      this.#Xa = setTimeout((() => {
        this.#Xa = null;
        this.#eo();
      }), 200);
    ...
    #Ja() {
      const { div: t2 } = this;
      let { width: e2, height: i2 } = this.#za;
      ...
      this._uiManager.enableWaiting(false);
      const l2 = this.#qa = document.createElement("canvas");
      ...
      this.#Wa && l2.setAttribute("aria-label", this.#Wa);
    }
    copyCanvas(t2, e2, i2 = false) {
      t2 || (t2 = 224);
      const { width: s2, height: n2 } = this.#za, r2 = new OutputScale();
      let a2 = this.#za, o2 = s2, l2 = n2, h2 = null;
      if (e2) {
        if (s2 > e2 || n2 > e2) {
    ...
    #io(t2, e2) {
      const { width: i2, height: s2 } = this.#za;
      let n2 = i2, r2 = s2, a2 = this.#za;
      for (; n2 > 2 * t2 || r2 > 2 * e2; ) {
        const i3 = n2, s3 = r2;
    ...
    #eo() {
      const [t2, e2] = this.parentDimensions, { width: i2, height: s2 } = this, n2 = new OutputScale(), r2 = Math.ceil(i2 * t2 * n2.sx), a2 = Math.ceil(s2 * e2 * n2.sy), o2 = this.#qa;
      if (!o2 || o2.width === r2 && o2.height === a2) return;
      o2.width = r2;
      o2.height = a2;
      const l2 = this.#Ya ? this.#za : this.#io(r2, a2), h2 = o2.getContext("2d");
    ...
    #so(t2) {
      if (t2) {
        if (this.#Ya) {
          const t4 = this._uiManager.imageManager.getSvgUrl(this.#ja);
          if (t4) return t4;
        }
        const t3 = document.createElement("canvas");
        ({ width: t3.width, height: t3.height } = this.#za);
        t3.getContext("2d").drawImage(this.#za, 0, 0);
        return t3.toDataURL();
      }
      if (this.#Ya) {
        ...
        n2.getContext("2d").drawImage(this.#za, 0, 0, this.#za.width, this.#za.height, 0, 0, i2, s2);
        return n2.transferToImageBitmap();
      }
      return structuredClone(this.#za);
    }
    static async deserialize(t2, e2, i2) {
      let s2 = null;
      if (t2 instanceof StampAnnotationElement) {
        ...
        d3.remove();
        const p2 = (await e2._structTree.getAriaAttributes(`${st}${a3}`))?.get("aria-label") || "";
        s2 = t2 = { annotationType: f.STAMP, bitmapId: u3.id, bitmap: u3.bitmap, pageIndex: c3 - 1, rect: n3.slice(0), rotation: r3, id: a3, deleted: false, accessibilityData: { decorative: false, altText: p2 }, isSvg: false, structParent: o3, popupRef: l3 };
      }
    ...
    serialize(t2 = false, e2 = null) {
      if (this.isEmpty()) return null;
      if (this.deleted) return this.serializeDeleted();
      const i2 = { annotationType: f.STAMP, bitmapId: this.#ja, pageIndex: this.pageIndex, rect: this.getRect(0, 0), rotation: this.rotation, isSvg: this.#Ya, structTreeParentId: this._structTreeParentId };
      if (t2) {
      ...
      const r2 = this.#Ya ? (i2.rect[2] - i2.rect[0]) * (i2.rect[3] - i2.rect[1]) : null;
      if (e2.stamps.has(this.#ja)) {
        if (this.#Ya) {
          const t3 = e2.stamps.get(this.#ja);
          if (r2 > t3.area) {
            t3.area = r2;
        ...
        e2.stamps.set(this.#ja, { area: r2, serialized: i2 });
  ...
  var AnnotationEditorLayer = class _AnnotationEditorLayer {
    ...
    static #z = new Map([FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map(((t2) => [t2._editorType, t2])));
    constructor({ uiManager: t2, pageIndex: e2, div: i2, structTreeLayer: s2, accessibilityManager: n2, annotationLayer: r2, drawLayer: a2, textLayer: o2, viewport: l2, l10n: h2 }) {
      const c2 = [..._AnnotationEditorLayer.#z.values()];
    ...
    updateToolbar(t2) {
      this.#f.updateToolbar(t2);
    }
    updateMode(t2 = this.#f.getMode()) {
      this.#mo();
      switch (t2) {
        case f.NONE:
      ...
      for (const i2 of _AnnotationEditorLayer.#z.values()) e2.toggle(`${i2._type}Editing`, t2 === i2._editorType);
    ...
    setEditingState(t2) {
      this.#f.setEditingState(t2);
    }
    addCommands(t2) {
      this.#f.addCommands(t2);
    }
    cleanUndoStack(t2) {
      this.#f.cleanUndoStack(t2);
    }
    ...
    toggleAnnotationLayerPointerEvents(t2 = false) {
      this.#ro?.div.classList.toggle("disabled", !t2);
    }
    async enable() {
      this.#do = true;
      this.div.tabIndex = 0;
      ...
      for (const e3 of this.#lo.values()) {
        ...
        if (e3.annotationElementId) {
          this.#f.removeChangedExistingAnnotation(e3);
      ...
      const e2 = this.#ro.getEditableAnnotations();
      for (const i2 of e2) {
        i2.hide();
        if (this.#f.isDeletedAnnotationElement(i2.data.id)) continue;
    ...
    disable() {
      ...
      if (this.#ro) {
        const i3 = this.#ro.getEditableAnnotations();
        for (const s2 of i3) {
          const { id: i4 } = s2.data;
          if (this.#f.isDeletedAnnotationElement(i4)) continue;
          let n2 = e2.get(i4);
          if (n2) {
            ...
            n2 = t2.get(i4);
            if (n2) {
              this.#f.addChangedExistingAnnotation(n2);
      ...
      for (const t3 of _AnnotationEditorLayer.#z.values()) i2.remove(`${t3._type}Editing`);
      this.disableTextSelection();
      this.toggleAnnotationLayerPointerEvents(true);
      this.#co = false;
    }
    getEditableAnnotation(t2) {
      return this.#ro?.getEditableAnnotation(t2) || null;
    }
    setActiveEditor(t2) {
      this.#f.getActive() !== t2 && this.#f.setActiveEditor(t2);
    }
    enableTextSelection() {
      this.div.tabIndex = -1;
      if (this.#go?.div && !this.#fo) {
        this.#fo = new AbortController();
        const t2 = this.#f.combinedSignal(this.#fo);
    ...
    #bo(t2) {
      ...
      if (e2 === this.#go.div || ("img" === e2.getAttribute("role") || e2.classList.contains("endOfContent")) && this.#go.div.contains(e2)) {
        ...
        this.#f.showAllEditors("highlight", true, true);
        this.#go.div.classList.add("free");
        this.toggleDrawing();
        HighlightEditor.startHighlighting(this, "ltr" === this.#f.direction, { target: this.#go.div, x: t2.x, y: t2.y });
        this.#go.div.addEventListener("pointerup", (() => {
          this.#go.div.classList.remove("free");
          this.toggleDrawing(true);
        }), { once: true, signal: this.#f._signal });
        t2.preventDefault();
      }
    }
    enableClick() {
      ...
      const t2 = this.#f.combinedSignal(this.#ao);
    ...
    attach(t2) {
      ...
      e2 && this.#f.isDeletedAnnotationElement(e2) && this.#f.removeDeletedAnnotationElement(t2);
    }
    detach(t2) {
      this.#lo.delete(t2.id);
      this.#Cn?.removePointerInTextLayer(t2.contentDiv);
      !this.#co && t2.annotationElementId && this.#f.addDeletedAnnotationElement(t2);
    }
    remove(t2) {
      this.detach(t2);
      this.#f.removeEditor(t2);
      t2.div.remove();
    ...
    changeParent(t2) {
      if (t2.parent !== this) {
        if (t2.parent && t2.annotationElementId) {
          this.#f.addDeletedAnnotationElement(t2.annotationElementId);
    ...
    add(t2) {
      if (t2.parent !== this || !t2.isAttachedToDOM) {
        ...
        t2.onceAdded(!this.#do);
        this.#f.addToAnnotationStorage(t2);
    ...
    get #vo() {
      return _AnnotationEditorLayer.#z.get(this.#f.getMode());
    }
    combinedSignal(t2) {
      return this.#f.combinedSignal(t2);
    }
    #yo(t2) {
      const e2 = this.#vo;
    ...
    canCreateNewEmptyEditor() {
      return this.#vo?.canCreateNewEmptyEditor();
    }
    pasteEditor(t2, e2) {
      this.#f.updateToolbar(t2);
      this.#f.updateMode(t2);
      const { offsetX: i2, offsetY: s2 } = this.#wo(), n2 = this.getNextId(), r2 = this.#yo({ parent: this, id: n2, x: i2, y: s2, uiManager: this.#f, isCentered: true, ...e2 });
      r2 && this.add(r2);
    }
    async deserialize(t2) {
      return await _AnnotationEditorLayer.#z.get(t2.annotationType ?? t2.annotationEditorType)?.deserialize(t2, this, this.#f) || null;
    }
    createAndAddNewEditor(t2, e2, i2 = {}) {
      const s2 = this.getNextId(), n2 = this.#yo({ parent: this, id: s2, x: t2.offsetX, y: t2.offsetY, uiManager: this.#f, isCentered: e2, ...i2 });
      n2 && this.add(n2);
      return n2;
    }
    #wo() {
      const { x: t2, y: e2, width: i2, height: s2 } = this.div.getBoundingClientRect(), n2 = Math.max(0, t2), r2 = Math.max(0, e2), a2 = (n2 + Math.min(window.innerWidth, t2 + i2)) / 2 - t2, o2 = (r2 + Math.min(window.innerHeight, e2 + s2)) / 2 - e2, [l2, h2] = this.viewport.rotation % 180 == 0 ? [a2, o2] : [o2, a2];
      return { offsetX: l2, offsetY: h2 };
    }
    addNewEditor() {
      this.createAndAddNewEditor(this.#wo(), true);
    }
    setSelected(t2) {
      this.#f.setSelected(t2);
    }
    toggleSelected(t2) {
      this.#f.toggleSelected(t2);
    }
    unselect(t2) {
      this.#f.unselect(t2);
    }
    pointerup(t2) {
      ...
      if (!(0 !== t2.button || t2.ctrlKey && e2) && t2.target === this.div && this.#ho) {
        this.#ho = false;
        this.#vo?.isDrawer && this.#vo.supportMultipleDrawings || (this.#no ? this.#f.getMode() !== f.STAMP ? this.createAndAddNewEditor(t2, false) : this.#f.unselectAll() : this.#no = true);
      }
    }
    pointerdown(t2) {
    ...
    endDrawingSession(t2 = false) {
      ...
      this.#uo = null;
      this.#po = null;
      return this.#vo.endDrawing(t2);
    }
    findNewParent(t2, e2, i2) {
      const s2 = this.#f.findParent(e2, i2);
    ...
    render({ viewport: t2 }) {
      ...
      for (const t3 of this.#f.getEditors(this.pageIndex)) {
        this.add(t3);
        t3.rebuild();
      }
      this.updateMode();
  ...
  var DrawLayer = class _DrawLayer {
    ...
    setParent(t2) {
      if (this.#nn) {
        if (this.#nn !== t2) {
          if (this.#Ao.size > 0) for (const e2 of this.#Ao.values()) {
            e2.remove();
            t2.append(e2);
          }
          this.#nn = t2;
    ...
    draw(t2, e2 = false, i2 = false) {
      const s2 = this.#y++, n2 = this.#Eo(), r2 = _DrawLayer._svgFactory.createElement("defs");
      n2.append(r2);
      ...
      e2 && this.#xo.set(s2, a2);
      const l2 = i2 ? this.#So(r2, o2) : null, h2 = _DrawLayer._svgFactory.createElement("use");
      n2.append(h2);
    ...
    drawOutline(t2, e2) {
      const i2 = this.#y++, s2 = this.#Eo(), n2 = _DrawLayer._svgFactory.createElement("defs");
      s2.append(n2);
    ...
    updateProperties(t2, e2) {
      if (!e2) return;
      const { root: i2, bbox: s2, rootClass: n2, path: r2 } = e2, a2 = "number" == typeof t2 ? this.#Ao.get(t2) : t2;
      if (a2) {
        i2 && this.#Co(a2, i2);
        s2 && _DrawLayer.#_o(a2, s2);
        if (n2) {
    ...
    remove(t2) {
      this.#xo.delete(t2);
      if (null !== this.#nn) {
        this.#Ao.get(t2).remove();
        this.#Ao.delete(t2);
      }
    }
    destroy() {
      this.#nn = null;
      for (const t2 of this.#Ao.values()) t2.remove();
      this.#Ao.clear();
      this.#xo.clear();
    }
  };
  globalThis.pdfjsTestingUtils = { HighlightOutliner };
  var Gt = __webpack_exports__.AbortException;
  var Vt = __webpack_exports__.AnnotationEditorLayer;
  var $t = __webpack_exports__.AnnotationEditorParamsType;
  var Wt = __webpack_exports__.AnnotationEditorType;
  var qt = __webpack_exports__.AnnotationEditorUIManager;
  var Xt = __webpack_exports__.AnnotationLayer;
  var Yt = __webpack_exports__.AnnotationMode;
  var Kt = __webpack_exports__.ColorPicker;
  var Qt = __webpack_exports__.DOMSVGFactory;
  var Jt = __webpack_exports__.DrawLayer;
  var Zt = __webpack_exports__.FeatureTest;
  var te = __webpack_exports__.GlobalWorkerOptions;
  var ee = __webpack_exports__.ImageKind;
  var ie = __webpack_exports__.InvalidPDFException;
  var se = __webpack_exports__.MissingPDFException;
  var ne = __webpack_exports__.OPS;
  var re = __webpack_exports__.OutputScale;
  var ae = __webpack_exports__.PDFDataRangeTransport;
  var oe = __webpack_exports__.PDFDateString;
  var le = __webpack_exports__.PDFWorker;
  var he = __webpack_exports__.PasswordResponses;
  var ce = __webpack_exports__.PermissionFlag;
  var de = __webpack_exports__.PixelsPerInch;
  var ue = __webpack_exports__.RenderingCancelledException;
  var pe = __webpack_exports__.TextLayer;
  var ge = __webpack_exports__.TouchManager;
  var fe = __webpack_exports__.UnexpectedResponseException;
  var me = __webpack_exports__.Util;
  var be = __webpack_exports__.VerbosityLevel;
  var ve = __webpack_exports__.XfaLayer;
  var ye = __webpack_exports__.build;
  var we = __webpack_exports__.createValidAbsoluteUrl;
  var Ae = __webpack_exports__.fetchData;
  var xe = __webpack_exports__.getDocument;
  var _e = __webpack_exports__.getFilenameFromUrl;
  var Ee = __webpack_exports__.getPdfFilenameFromUrl;
  var Se = __webpack_exports__.getXfaPageViewport;
  var Ce = __webpack_exports__.isDataScheme;
  var Te = __webpack_exports__.isPdfFile;
  var Me = __webpack_exports__.noContextMenu;
  var Pe = __webpack_exports__.normalizeUnicode;
  var De = __webpack_exports__.setLayerDimensions;
  var ke = __webpack_exports__.shadow;
  var Re = __webpack_exports__.stopEvent;
  var Ie = __webpack_exports__.version;
